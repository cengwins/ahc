from ...GenericModel import GenericModel, Event, GenericMessage, GenericMessageHeader, EventTypes, ComponentRegistry, Lock, Thread, Topology
import time
import numpy as np


class FredericksonAlgorithmSimpleComponent(GenericModel):
