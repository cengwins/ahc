...
class AhcUhdUtils(SDRUtils):
    ...
    def configureSdr(self, type="b200", sdrconfig=None):
        ...
        self.usrp = uhd.usrp.MultiUSRP(f"{self.devicename},num_recv_frames=1024,num_send_frames=1024,recv_buff_size=8192,send_buff_size=8192,send_frame_size=8192,recv_frame_size=8192")
