...
from Routing.DSRAlgorithm.MonteCarloExperiment.ApplicationComponent import ApplicationComponent
from Routing.DSRAlgorithm.MonteCarloExperiment.DSRAlgorithmComponent import DSRAlgorithmComponent
from Routing.DSRAlgorithm.MonteCarloExperiment.DSRAlgorithmComponent import MessageTypes
...
class AdhocNodeComponent(ComponentModel):
    ...
    def send_unicast_message(self, next_hop, payload):
        ...
        # MonteCarloAddition
        if MessageTypes.ROUTE_REQUEST == payload.header.messagetype:
            DataCollector().increase_request_message_count()
            DataCollector().set_req_msg_sent_recently(True)
