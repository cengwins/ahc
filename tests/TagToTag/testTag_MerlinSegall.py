...
from TagToTag.GenericTag_MerlinSegall import TagComponent, TagMessageDestinationIdentifiers, TagMessageTypes
...
initiator_tag_id = 0
topo.nodes[initiator_tag_id].mainTagComponent.start_initiator(node_count)

time.sleep(3)

starting_time = topo.nodes[initiator_tag_id].mainTagComponent.starting_message_timestamp
ending_time = topo.nodes[initiator_tag_id].mainTagComponent.ending_message_timestamp
