...
liquid_libversion = _libraries['FIXME_STUB'].liquid_libversion
liquid_libversion.restype = ctypes.POINTER(ctypes.c_char)
liquid_libversion.argtypes = []
liquid_libversion_number = _libraries['FIXME_STUB'].liquid_libversion_number
...
liquid_error_info = _libraries['FIXME_STUB'].liquid_error_info
...
agc_crcf_execute_block = _libraries['FIXME_STUB'].agc_crcf_execute_block
...
cbufferf_release = _libraries['FIXME_STUB'].cbufferf_release
...
cbuffercf_release = _libraries['FIXME_STUB'].cbuffercf_release
...
windowcf_index = _libraries['FIXME_STUB'].windowcf_index
...
windowcf_push = _libraries['FIXME_STUB'].windowcf_push
windowcf_push.restype = ctypes.c_int32
windowcf_push.argtypes = [windowcf, liquid_float_complex]
windowcf_write = _libraries['FIXME_STUB'].windowcf_write
...
channel_cccf_add_multipath = _libraries['FIXME_STUB'].channel_cccf_add_multipath
...
channel_cccf_add_shadowing = _libraries['FIXME_STUB'].channel_cccf_add_shadowing
...
channel_cccf_execute = _libraries['FIXME_STUB'].channel_cccf_execute
...
channel_cccf_execute_block = _libraries['FIXME_STUB'].channel_cccf_execute_block
...
tvmpch_cccf_execute_block = _libraries['FIXME_STUB'].tvmpch_cccf_execute_block
...
dotprod_rrrf_run = _libraries['FIXME_STUB'].dotprod_rrrf_run
...
dotprod_rrrf_run4 = _libraries['FIXME_STUB'].dotprod_rrrf_run4
...
dotprod_rrrf_create = _libraries['FIXME_STUB'].dotprod_rrrf_create
dotprod_rrrf_create.restype = dotprod_rrrf
dotprod_rrrf_create.argtypes = [ctypes.POINTER(ctypes.c_float), ctypes.c_uint32]
dotprod_rrrf_recreate = _libraries['FIXME_STUB'].dotprod_rrrf_recreate
...
dotprod_rrrf_destroy = _libraries['FIXME_STUB'].dotprod_rrrf_destroy
dotprod_rrrf_destroy.restype = None
dotprod_rrrf_destroy.argtypes = [dotprod_rrrf]
dotprod_rrrf_print = _libraries['FIXME_STUB'].dotprod_rrrf_print
dotprod_rrrf_print.restype = None
dotprod_rrrf_print.argtypes = [dotprod_rrrf]
dotprod_rrrf_execute = _libraries['FIXME_STUB'].dotprod_rrrf_execute
...
dotprod_cccf_run = _libraries['FIXME_STUB'].dotprod_cccf_run
...
dotprod_cccf_run4 = _libraries['FIXME_STUB'].dotprod_cccf_run4
...
dotprod_cccf_create = _libraries['FIXME_STUB'].dotprod_cccf_create
...
dotprod_cccf_recreate = _libraries['FIXME_STUB'].dotprod_cccf_recreate
...
dotprod_cccf_destroy = _libraries['FIXME_STUB'].dotprod_cccf_destroy
dotprod_cccf_destroy.restype = None
dotprod_cccf_destroy.argtypes = [dotprod_cccf]
dotprod_cccf_print = _libraries['FIXME_STUB'].dotprod_cccf_print
dotprod_cccf_print.restype = None
dotprod_cccf_print.argtypes = [dotprod_cccf]
dotprod_cccf_execute = _libraries['FIXME_STUB'].dotprod_cccf_execute
...
dotprod_crcf_run = _libraries['FIXME_STUB'].dotprod_crcf_run
...
dotprod_crcf_run4 = _libraries['FIXME_STUB'].dotprod_crcf_run4
...
dotprod_crcf_create = _libraries['FIXME_STUB'].dotprod_crcf_create
dotprod_crcf_create.restype = dotprod_crcf
dotprod_crcf_create.argtypes = [ctypes.POINTER(ctypes.c_float), ctypes.c_uint32]
dotprod_crcf_recreate = _libraries['FIXME_STUB'].dotprod_crcf_recreate
...
dotprod_crcf_destroy = _libraries['FIXME_STUB'].dotprod_crcf_destroy
dotprod_crcf_destroy.restype = None
dotprod_crcf_destroy.argtypes = [dotprod_crcf]
dotprod_crcf_print = _libraries['FIXME_STUB'].dotprod_crcf_print
dotprod_crcf_print.restype = None
dotprod_crcf_print.argtypes = [dotprod_crcf]
dotprod_crcf_execute = _libraries['FIXME_STUB'].dotprod_crcf_execute
...
eqlms_rrrf_create = _libraries['FIXME_STUB'].eqlms_rrrf_create
eqlms_rrrf_create.restype = eqlms_rrrf
eqlms_rrrf_create.argtypes = [ctypes.POINTER(ctypes.c_float), ctypes.c_uint32]
eqlms_rrrf_create_rnyquist = _libraries['FIXME_STUB'].eqlms_rrrf_create_rnyquist
...
eqlms_rrrf_create_lowpass = _libraries['FIXME_STUB'].eqlms_rrrf_create_lowpass
eqlms_rrrf_create_lowpass.restype = eqlms_rrrf
eqlms_rrrf_create_lowpass.argtypes = [ctypes.c_uint32, ctypes.c_float]
eqlms_rrrf_recreate = _libraries['FIXME_STUB'].eqlms_rrrf_recreate
...
eqlms_rrrf_execute = _libraries['FIXME_STUB'].eqlms_rrrf_execute
eqlms_rrrf_execute.restype = ctypes.c_int32
eqlms_rrrf_execute.argtypes = [eqlms_rrrf, ctypes.POINTER(ctypes.c_float)]
eqlms_rrrf_execute_block = _libraries['FIXME_STUB'].eqlms_rrrf_execute_block
...
eqlms_cccf_create = _libraries['FIXME_STUB'].eqlms_cccf_create
...
eqlms_cccf_create_rnyquist = _libraries['FIXME_STUB'].eqlms_cccf_create_rnyquist
...
eqlms_cccf_create_lowpass = _libraries['FIXME_STUB'].eqlms_cccf_create_lowpass
eqlms_cccf_create_lowpass.restype = eqlms_cccf
eqlms_cccf_create_lowpass.argtypes = [ctypes.c_uint32, ctypes.c_float]
eqlms_cccf_recreate = _libraries['FIXME_STUB'].eqlms_cccf_recreate
...
eqlms_cccf_execute = _libraries['FIXME_STUB'].eqlms_cccf_execute
...
eqlms_cccf_execute_block = _libraries['FIXME_STUB'].eqlms_cccf_execute_block
...
eqlms_cccf_train = _libraries['FIXME_STUB'].eqlms_cccf_train
...
eqrls_rrrf_create = _libraries['FIXME_STUB'].eqrls_rrrf_create
eqrls_rrrf_create.restype = eqrls_rrrf
eqrls_rrrf_create.argtypes = [ctypes.POINTER(ctypes.c_float), ctypes.c_uint32]
eqrls_rrrf_recreate = _libraries['FIXME_STUB'].eqrls_rrrf_recreate
...
eqrls_cccf_create = _libraries['FIXME_STUB'].eqrls_cccf_create
...
eqrls_cccf_recreate = _libraries['FIXME_STUB'].eqrls_cccf_recreate
...
eqrls_cccf_step = _libraries['FIXME_STUB'].eqrls_cccf_step
eqrls_cccf_step.restype = ctypes.c_int32
eqrls_cccf_step.argtypes = [eqrls_cccf, liquid_float_complex, liquid_float_complex]
eqrls_cccf_get_weights = _libraries['FIXME_STUB'].eqrls_cccf_get_weights
...
eqrls_cccf_train = _libraries['FIXME_STUB'].eqrls_cccf_train
...
liquid_print_crc_schemes = _libraries['FIXME_STUB'].liquid_print_crc_schemes
liquid_print_crc_schemes.restype = None
liquid_print_crc_schemes.argtypes = []
liquid_getopt_str2crc = _libraries['FIXME_STUB'].liquid_getopt_str2crc
liquid_getopt_str2crc.restype = crc_scheme
liquid_getopt_str2crc.argtypes = [ctypes.POINTER(ctypes.c_char)]
crc_get_length = _libraries['FIXME_STUB'].crc_get_length
crc_get_length.restype = ctypes.c_uint32
crc_get_length.argtypes = [crc_scheme]
crc_generate_key = _libraries['FIXME_STUB'].crc_generate_key
...
liquid_print_fec_schemes = _libraries['FIXME_STUB'].liquid_print_fec_schemes
liquid_print_fec_schemes.restype = None
liquid_print_fec_schemes.argtypes = []
liquid_getopt_str2fec = _libraries['FIXME_STUB'].liquid_getopt_str2fec
...
fec_decode = _libraries['FIXME_STUB'].fec_decode
...
fec_decode_soft = _libraries['FIXME_STUB'].fec_decode_soft
...
packetizer_compute_enc_msg_len = _libraries['FIXME_STUB'].packetizer_compute_enc_msg_len
...
packetizer_compute_dec_msg_len = _libraries['FIXME_STUB'].packetizer_compute_dec_msg_len
...
packetizer_create = _libraries['FIXME_STUB'].packetizer_create
...
packetizer_recreate = _libraries['FIXME_STUB'].packetizer_recreate
...
packetizer_decode = _libraries['FIXME_STUB'].packetizer_decode
...
packetizer_decode_soft = _libraries['FIXME_STUB'].packetizer_decode_soft
...
interleaver_encode_soft = _libraries['FIXME_STUB'].interleaver_encode_soft
...
interleaver_decode = _libraries['FIXME_STUB'].interleaver_decode
...
interleaver_decode_soft = _libraries['FIXME_STUB'].interleaver_decode_soft
...
fft_create_plan = _libraries['FIXME_STUB'].fft_create_plan
...
fft_create_plan_r2r_1d = _libraries['FIXME_STUB'].fft_create_plan_r2r_1d
...
fft_r2r_1d_run = _libraries['FIXME_STUB'].fft_r2r_1d_run
...
fft_shift = _libraries['FIXME_STUB'].fft_shift
...
asgramcf_execute = _libraries['FIXME_STUB'].asgramcf_execute
...
asgramcf_print = _libraries['FIXME_STUB'].asgramcf_print
...
asgramf_print = _libraries['FIXME_STUB'].asgramf_print
...
spwaterfallcf_create = _libraries['FIXME_STUB'].spwaterfallcf_create
...
spwaterfallcf_set_commands = _libraries['FIXME_STUB'].spwaterfallcf_set_commands
...
spwaterfallcf_push = _libraries['FIXME_STUB'].spwaterfallcf_push
spwaterfallcf_push.restype = ctypes.c_int32
spwaterfallcf_push.argtypes = [spwaterfallcf, liquid_float_complex]
spwaterfallcf_write = _libraries['FIXME_STUB'].spwaterfallcf_write
...
spwaterfallcf_export = _libraries['FIXME_STUB'].spwaterfallcf_export
...
spwaterfallf_create = _libraries['FIXME_STUB'].spwaterfallf_create
...
spwaterfallf_push = _libraries['FIXME_STUB'].spwaterfallf_push
spwaterfallf_push.restype = ctypes.c_int32
spwaterfallf_push.argtypes = [spwaterfallf, ctypes.c_float]
spwaterfallf_write = _libraries['FIXME_STUB'].spwaterfallf_write
...
spwaterfallf_export = _libraries['FIXME_STUB'].spwaterfallf_export
...
liquid_firdes_prototype = _libraries['FIXME_STUB'].liquid_firdes_prototype
...
firdespm_run = _libraries['FIXME_STUB'].firdespm_run
...
firdespm_lowpass = _libraries['FIXME_STUB'].firdespm_lowpass
...
firdespm_create = _libraries['FIXME_STUB'].firdespm_create
...
firdespm_create_callback = _libraries['FIXME_STUB'].firdespm_create_callback
...
liquid_firdes_notch = _libraries['FIXME_STUB'].liquid_firdes_notch
...
liquid_firdes_doppler = _libraries['FIXME_STUB'].liquid_firdes_doppler
...
liquid_firdes_rcos = _libraries['FIXME_STUB'].liquid_firdes_rcos
...
liquid_firdes_rrcos = _libraries['FIXME_STUB'].liquid_firdes_rrcos
...
liquid_firdes_rkaiser = _libraries['FIXME_STUB'].liquid_firdes_rkaiser
...
liquid_firdes_arkaiser = _libraries['FIXME_STUB'].liquid_firdes_arkaiser
...
liquid_firdes_hM3 = _libraries['FIXME_STUB'].liquid_firdes_hM3
...
liquid_firdes_gmsktx = _libraries['FIXME_STUB'].liquid_firdes_gmsktx
...
liquid_firdes_gmskrx = _libraries['FIXME_STUB'].liquid_firdes_gmskrx
...
liquid_firdes_fexp = _libraries['FIXME_STUB'].liquid_firdes_fexp
...
liquid_firdes_rfexp = _libraries['FIXME_STUB'].liquid_firdes_rfexp
...
liquid_firdes_fsech = _libraries['FIXME_STUB'].liquid_firdes_fsech
...
liquid_firdes_rfsech = _libraries['FIXME_STUB'].liquid_firdes_rfsech
...
liquid_firdes_farcsech = _libraries['FIXME_STUB'].liquid_firdes_farcsech
...
liquid_firdes_rfarcsech = _libraries['FIXME_STUB'].liquid_firdes_rfarcsech
...
fir_group_delay = _libraries['FIXME_STUB'].fir_group_delay
...
iir_group_delay = _libraries['FIXME_STUB'].iir_group_delay
...
liquid_filter_autocorr = _libraries['FIXME_STUB'].liquid_filter_autocorr
...
liquid_filter_crosscorr = _libraries['FIXME_STUB'].liquid_filter_crosscorr
...
liquid_filter_isi = _libraries['FIXME_STUB'].liquid_filter_isi
...
liquid_filter_energy = _libraries['FIXME_STUB'].liquid_filter_energy
...
liquid_iirdes = _libraries['FIXME_STUB'].liquid_iirdes
...
butter_azpkf = _libraries['FIXME_STUB'].butter_azpkf
...
cheby1_azpkf = _libraries['FIXME_STUB'].cheby1_azpkf
...
cheby2_azpkf = _libraries['FIXME_STUB'].cheby2_azpkf
...
ellip_azpkf = _libraries['FIXME_STUB'].ellip_azpkf
...
bessel_azpkf = _libraries['FIXME_STUB'].bessel_azpkf
...
iirdes_freqprewarp = _libraries['FIXME_STUB'].iirdes_freqprewarp
...
bilinear_zpkf = _libraries['FIXME_STUB'].bilinear_zpkf
...
iirdes_dzpk_lp2hp = _libraries['FIXME_STUB'].iirdes_dzpk_lp2hp
...
iirdes_dzpk_lp2bp = _libraries['FIXME_STUB'].iirdes_dzpk_lp2bp
...
iirdes_dzpk2tff = _libraries['FIXME_STUB'].iirdes_dzpk2tff
...
iirdes_dzpk2sosf = _libraries['FIXME_STUB'].iirdes_dzpk2sosf
...
iirdes_pll_active_lag = _libraries['FIXME_STUB'].iirdes_pll_active_lag
...
iirdes_pll_active_PI = _libraries['FIXME_STUB'].iirdes_pll_active_PI
...
iirdes_isstable = _libraries['FIXME_STUB'].iirdes_isstable
...
liquid_lpc = _libraries['FIXME_STUB'].liquid_lpc
...
liquid_levinson = _libraries['FIXME_STUB'].liquid_levinson
...
autocorr_cccf_execute = _libraries['FIXME_STUB'].autocorr_cccf_execute
...
autocorr_cccf_execute_block = _libraries['FIXME_STUB'].autocorr_cccf_execute_block
...
autocorr_cccf_get_energy = _libraries['FIXME_STUB'].autocorr_cccf_get_energy
...
autocorr_rrrf_get_energy = _libraries['FIXME_STUB'].autocorr_rrrf_get_energy
...
firfilt_rrrf_create = _libraries['FIXME_STUB'].firfilt_rrrf_create
firfilt_rrrf_create.restype = firfilt_rrrf
firfilt_rrrf_create.argtypes = [ctypes.POINTER(ctypes.c_float), ctypes.c_uint32]
firfilt_rrrf_create_kaiser = _libraries['FIXME_STUB'].firfilt_rrrf_create_kaiser
...
firfilt_rrrf_create_rnyquist = _libraries['FIXME_STUB'].firfilt_rrrf_create_rnyquist
...
firfilt_rrrf_create_firdespm = _libraries['FIXME_STUB'].firfilt_rrrf_create_firdespm
...
firfilt_rrrf_create_rect = _libraries['FIXME_STUB'].firfilt_rrrf_create_rect
firfilt_rrrf_create_rect.restype = firfilt_rrrf
firfilt_rrrf_create_rect.argtypes = [ctypes.c_uint32]
firfilt_rrrf_create_dc_blocker = _libraries['FIXME_STUB'].firfilt_rrrf_create_dc_blocker
...
firfilt_rrrf_create_notch = _libraries['FIXME_STUB'].firfilt_rrrf_create_notch
...
firfilt_rrrf_recreate = _libraries['FIXME_STUB'].firfilt_rrrf_recreate
...
firfilt_rrrf_get_length = _libraries['FIXME_STUB'].firfilt_rrrf_get_length
firfilt_rrrf_get_length.restype = ctypes.c_uint32
firfilt_rrrf_get_length.argtypes = [firfilt_rrrf]
firfilt_rrrf_get_coefficients = _libraries['FIXME_STUB'].firfilt_rrrf_get_coefficients
...
firfilt_rrrf_freqresponse = _libraries['FIXME_STUB'].firfilt_rrrf_freqresponse
...
firfilt_rrrf_groupdelay = _libraries['FIXME_STUB'].firfilt_rrrf_groupdelay
...
firfilt_crcf_create = _libraries['FIXME_STUB'].firfilt_crcf_create
firfilt_crcf_create.restype = firfilt_crcf
firfilt_crcf_create.argtypes = [ctypes.POINTER(ctypes.c_float), ctypes.c_uint32]
firfilt_crcf_create_kaiser = _libraries['FIXME_STUB'].firfilt_crcf_create_kaiser
...
firfilt_crcf_create_rnyquist = _libraries['FIXME_STUB'].firfilt_crcf_create_rnyquist
...
firfilt_crcf_create_firdespm = _libraries['FIXME_STUB'].firfilt_crcf_create_firdespm
...
firfilt_crcf_create_rect = _libraries['FIXME_STUB'].firfilt_crcf_create_rect
firfilt_crcf_create_rect.restype = firfilt_crcf
firfilt_crcf_create_rect.argtypes = [ctypes.c_uint32]
firfilt_crcf_create_dc_blocker = _libraries['FIXME_STUB'].firfilt_crcf_create_dc_blocker
...
firfilt_crcf_create_notch = _libraries['FIXME_STUB'].firfilt_crcf_create_notch
...
firfilt_crcf_recreate = _libraries['FIXME_STUB'].firfilt_crcf_recreate
...
firfilt_crcf_execute = _libraries['FIXME_STUB'].firfilt_crcf_execute
...
firfilt_crcf_execute_block = _libraries['FIXME_STUB'].firfilt_crcf_execute_block
...
firfilt_crcf_get_length = _libraries['FIXME_STUB'].firfilt_crcf_get_length
firfilt_crcf_get_length.restype = ctypes.c_uint32
firfilt_crcf_get_length.argtypes = [firfilt_crcf]
firfilt_crcf_get_coefficients = _libraries['FIXME_STUB'].firfilt_crcf_get_coefficients
...
firfilt_crcf_freqresponse = _libraries['FIXME_STUB'].firfilt_crcf_freqresponse
...
firfilt_crcf_groupdelay = _libraries['FIXME_STUB'].firfilt_crcf_groupdelay
...
firfilt_cccf_create = _libraries['FIXME_STUB'].firfilt_cccf_create
...
firfilt_cccf_create_kaiser = _libraries['FIXME_STUB'].firfilt_cccf_create_kaiser
...
firfilt_cccf_create_rnyquist = _libraries['FIXME_STUB'].firfilt_cccf_create_rnyquist
...
firfilt_cccf_create_firdespm = _libraries['FIXME_STUB'].firfilt_cccf_create_firdespm
...
firfilt_cccf_create_rect = _libraries['FIXME_STUB'].firfilt_cccf_create_rect
firfilt_cccf_create_rect.restype = firfilt_cccf
firfilt_cccf_create_rect.argtypes = [ctypes.c_uint32]
firfilt_cccf_create_dc_blocker = _libraries['FIXME_STUB'].firfilt_cccf_create_dc_blocker
...
firfilt_cccf_create_notch = _libraries['FIXME_STUB'].firfilt_cccf_create_notch
...
firfilt_cccf_recreate = _libraries['FIXME_STUB'].firfilt_cccf_recreate
...
firfilt_cccf_push = _libraries['FIXME_STUB'].firfilt_cccf_push
firfilt_cccf_push.restype = None
firfilt_cccf_push.argtypes = [firfilt_cccf, liquid_float_complex]
firfilt_cccf_write = _libraries['FIXME_STUB'].firfilt_cccf_write
...
firfilt_cccf_execute = _libraries['FIXME_STUB'].firfilt_cccf_execute
...
firfilt_cccf_execute_block = _libraries['FIXME_STUB'].firfilt_cccf_execute_block
...
firfilt_cccf_get_length = _libraries['FIXME_STUB'].firfilt_cccf_get_length
firfilt_cccf_get_length.restype = ctypes.c_uint32
firfilt_cccf_get_length.argtypes = [firfilt_cccf]
firfilt_cccf_get_coefficients = _libraries['FIXME_STUB'].firfilt_cccf_get_coefficients
...
firfilt_cccf_freqresponse = _libraries['FIXME_STUB'].firfilt_cccf_freqresponse
...
firfilt_cccf_groupdelay = _libraries['FIXME_STUB'].firfilt_cccf_groupdelay
...
firhilbf_create = _libraries['FIXME_STUB'].firhilbf_create
firhilbf_create.restype = firhilbf
firhilbf_create.argtypes = [ctypes.c_uint32, ctypes.c_float]
firhilbf_destroy = _libraries['FIXME_STUB'].firhilbf_destroy
firhilbf_destroy.restype = None
firhilbf_destroy.argtypes = [firhilbf]
firhilbf_print = _libraries['FIXME_STUB'].firhilbf_print
firhilbf_print.restype = None
firhilbf_print.argtypes = [firhilbf]
firhilbf_reset = _libraries['FIXME_STUB'].firhilbf_reset
firhilbf_reset.restype = None
firhilbf_reset.argtypes = [firhilbf]
firhilbf_r2c_execute = _libraries['FIXME_STUB'].firhilbf_r2c_execute
...
firhilbf_c2r_execute = _libraries['FIXME_STUB'].firhilbf_c2r_execute
...
firhilbf_decim_execute = _libraries['FIXME_STUB'].firhilbf_decim_execute
...
firhilbf_decim_execute_block = _libraries['FIXME_STUB'].firhilbf_decim_execute_block
...
firhilbf_interp_execute = _libraries['FIXME_STUB'].firhilbf_interp_execute
...
firhilbf_interp_execute_block = _libraries['FIXME_STUB'].firhilbf_interp_execute_block
...
iirhilbf_create = _libraries['FIXME_STUB'].iirhilbf_create
...
iirhilbf_create_default = _libraries['FIXME_STUB'].iirhilbf_create_default
iirhilbf_create_default.restype = iirhilbf
iirhilbf_create_default.argtypes = [ctypes.c_uint32]
iirhilbf_destroy = _libraries['FIXME_STUB'].iirhilbf_destroy
iirhilbf_destroy.restype = None
iirhilbf_destroy.argtypes = [iirhilbf]
iirhilbf_print = _libraries['FIXME_STUB'].iirhilbf_print
iirhilbf_print.restype = None
iirhilbf_print.argtypes = [iirhilbf]
iirhilbf_reset = _libraries['FIXME_STUB'].iirhilbf_reset
iirhilbf_reset.restype = None
iirhilbf_reset.argtypes = [iirhilbf]
iirhilbf_r2c_execute = _libraries['FIXME_STUB'].iirhilbf_r2c_execute
...
iirhilbf_c2r_execute = _libraries['FIXME_STUB'].iirhilbf_c2r_execute
...
iirhilbf_decim_execute = _libraries['FIXME_STUB'].iirhilbf_decim_execute
...
iirhilbf_decim_execute_block = _libraries['FIXME_STUB'].iirhilbf_decim_execute_block
...
iirhilbf_interp_execute = _libraries['FIXME_STUB'].iirhilbf_interp_execute
...
iirhilbf_interp_execute_block = _libraries['FIXME_STUB'].iirhilbf_interp_execute_block
...
fftfilt_rrrf_create = _libraries['FIXME_STUB'].fftfilt_rrrf_create
...
fftfilt_rrrf_get_length = _libraries['FIXME_STUB'].fftfilt_rrrf_get_length
...
fftfilt_crcf_create = _libraries['FIXME_STUB'].fftfilt_crcf_create
...
fftfilt_crcf_get_length = _libraries['FIXME_STUB'].fftfilt_crcf_get_length
...
fftfilt_cccf_create = _libraries['FIXME_STUB'].fftfilt_cccf_create
...
fftfilt_cccf_execute = _libraries['FIXME_STUB'].fftfilt_cccf_execute
...
fftfilt_cccf_get_length = _libraries['FIXME_STUB'].fftfilt_cccf_get_length
...
iirfilt_rrrf_create = _libraries['FIXME_STUB'].iirfilt_rrrf_create
...
iirfilt_rrrf_create_sos = _libraries['FIXME_STUB'].iirfilt_rrrf_create_sos
...
iirfilt_rrrf_create_prototype = _libraries['FIXME_STUB'].iirfilt_rrrf_create_prototype
...
iirfilt_rrrf_get_length = _libraries['FIXME_STUB'].iirfilt_rrrf_get_length
iirfilt_rrrf_get_length.restype = ctypes.c_uint32
iirfilt_rrrf_get_length.argtypes = [iirfilt_rrrf]
iirfilt_rrrf_freqresponse = _libraries['FIXME_STUB'].iirfilt_rrrf_freqresponse
...
iirfilt_rrrf_groupdelay = _libraries['FIXME_STUB'].iirfilt_rrrf_groupdelay
...
iirfilt_crcf_create = _libraries['FIXME_STUB'].iirfilt_crcf_create
...
iirfilt_crcf_create_sos = _libraries['FIXME_STUB'].iirfilt_crcf_create_sos
...
iirfilt_crcf_create_prototype = _libraries['FIXME_STUB'].iirfilt_crcf_create_prototype
...
iirfilt_crcf_destroy = _libraries['FIXME_STUB'].iirfilt_crcf_destroy
iirfilt_crcf_destroy.restype = None
iirfilt_crcf_destroy.argtypes = [iirfilt_crcf]
iirfilt_crcf_print = _libraries['FIXME_STUB'].iirfilt_crcf_print
iirfilt_crcf_print.restype = None
iirfilt_crcf_print.argtypes = [iirfilt_crcf]
iirfilt_crcf_reset = _libraries['FIXME_STUB'].iirfilt_crcf_reset
iirfilt_crcf_reset.restype = None
iirfilt_crcf_reset.argtypes = [iirfilt_crcf]
iirfilt_crcf_execute = _libraries['FIXME_STUB'].iirfilt_crcf_execute
...
iirfilt_crcf_execute_block = _libraries['FIXME_STUB'].iirfilt_crcf_execute_block
...
iirfilt_crcf_get_length = _libraries['FIXME_STUB'].iirfilt_crcf_get_length
iirfilt_crcf_get_length.restype = ctypes.c_uint32
iirfilt_crcf_get_length.argtypes = [iirfilt_crcf]
iirfilt_crcf_freqresponse = _libraries['FIXME_STUB'].iirfilt_crcf_freqresponse
...
iirfilt_crcf_groupdelay = _libraries['FIXME_STUB'].iirfilt_crcf_groupdelay
...
iirfilt_cccf_create = _libraries['FIXME_STUB'].iirfilt_cccf_create
...
iirfilt_cccf_create_sos = _libraries['FIXME_STUB'].iirfilt_cccf_create_sos
...
iirfilt_cccf_create_prototype = _libraries['FIXME_STUB'].iirfilt_cccf_create_prototype
...
iirfilt_cccf_destroy = _libraries['FIXME_STUB'].iirfilt_cccf_destroy
iirfilt_cccf_destroy.restype = None
iirfilt_cccf_destroy.argtypes = [iirfilt_cccf]
iirfilt_cccf_print = _libraries['FIXME_STUB'].iirfilt_cccf_print
iirfilt_cccf_print.restype = None
iirfilt_cccf_print.argtypes = [iirfilt_cccf]
iirfilt_cccf_reset = _libraries['FIXME_STUB'].iirfilt_cccf_reset
iirfilt_cccf_reset.restype = None
iirfilt_cccf_reset.argtypes = [iirfilt_cccf]
iirfilt_cccf_execute = _libraries['FIXME_STUB'].iirfilt_cccf_execute
...
iirfilt_cccf_execute_block = _libraries['FIXME_STUB'].iirfilt_cccf_execute_block
...
iirfilt_cccf_get_length = _libraries['FIXME_STUB'].iirfilt_cccf_get_length
iirfilt_cccf_get_length.restype = ctypes.c_uint32
iirfilt_cccf_get_length.argtypes = [iirfilt_cccf]
iirfilt_cccf_freqresponse = _libraries['FIXME_STUB'].iirfilt_cccf_freqresponse
...
iirfilt_cccf_groupdelay = _libraries['FIXME_STUB'].iirfilt_cccf_groupdelay
...
iirfiltsos_rrrf_create = _libraries['FIXME_STUB'].iirfiltsos_rrrf_create
...
iirfiltsos_rrrf_set_coefficients = _libraries['FIXME_STUB'].iirfiltsos_rrrf_set_coefficients
...
iirfiltsos_rrrf_destroy = _libraries['FIXME_STUB'].iirfiltsos_rrrf_destroy
iirfiltsos_rrrf_destroy.restype = None
iirfiltsos_rrrf_destroy.argtypes = [iirfiltsos_rrrf]
iirfiltsos_rrrf_print = _libraries['FIXME_STUB'].iirfiltsos_rrrf_print
iirfiltsos_rrrf_print.restype = None
iirfiltsos_rrrf_print.argtypes = [iirfiltsos_rrrf]
iirfiltsos_rrrf_reset = _libraries['FIXME_STUB'].iirfiltsos_rrrf_reset
iirfiltsos_rrrf_reset.restype = None
iirfiltsos_rrrf_reset.argtypes = [iirfiltsos_rrrf]
iirfiltsos_rrrf_execute = _libraries['FIXME_STUB'].iirfiltsos_rrrf_execute
...
iirfiltsos_rrrf_execute_df1 = _libraries['FIXME_STUB'].iirfiltsos_rrrf_execute_df1
...
iirfiltsos_rrrf_execute_df2 = _libraries['FIXME_STUB'].iirfiltsos_rrrf_execute_df2
...
iirfiltsos_rrrf_groupdelay = _libraries['FIXME_STUB'].iirfiltsos_rrrf_groupdelay
...
iirfiltsos_crcf_create = _libraries['FIXME_STUB'].iirfiltsos_crcf_create
...
iirfiltsos_crcf_set_coefficients = _libraries['FIXME_STUB'].iirfiltsos_crcf_set_coefficients
...
iirfiltsos_crcf_destroy = _libraries['FIXME_STUB'].iirfiltsos_crcf_destroy
iirfiltsos_crcf_destroy.restype = None
iirfiltsos_crcf_destroy.argtypes = [iirfiltsos_crcf]
iirfiltsos_crcf_print = _libraries['FIXME_STUB'].iirfiltsos_crcf_print
iirfiltsos_crcf_print.restype = None
iirfiltsos_crcf_print.argtypes = [iirfiltsos_crcf]
iirfiltsos_crcf_reset = _libraries['FIXME_STUB'].iirfiltsos_crcf_reset
iirfiltsos_crcf_reset.restype = None
iirfiltsos_crcf_reset.argtypes = [iirfiltsos_crcf]
iirfiltsos_crcf_execute = _libraries['FIXME_STUB'].iirfiltsos_crcf_execute
...
iirfiltsos_crcf_execute_df1 = _libraries['FIXME_STUB'].iirfiltsos_crcf_execute_df1
...
iirfiltsos_crcf_execute_df2 = _libraries['FIXME_STUB'].iirfiltsos_crcf_execute_df2
...
iirfiltsos_crcf_groupdelay = _libraries['FIXME_STUB'].iirfiltsos_crcf_groupdelay
...
iirfiltsos_cccf_create = _libraries['FIXME_STUB'].iirfiltsos_cccf_create
...
iirfiltsos_cccf_set_coefficients = _libraries['FIXME_STUB'].iirfiltsos_cccf_set_coefficients
...
iirfiltsos_cccf_destroy = _libraries['FIXME_STUB'].iirfiltsos_cccf_destroy
iirfiltsos_cccf_destroy.restype = None
iirfiltsos_cccf_destroy.argtypes = [iirfiltsos_cccf]
iirfiltsos_cccf_print = _libraries['FIXME_STUB'].iirfiltsos_cccf_print
iirfiltsos_cccf_print.restype = None
iirfiltsos_cccf_print.argtypes = [iirfiltsos_cccf]
iirfiltsos_cccf_reset = _libraries['FIXME_STUB'].iirfiltsos_cccf_reset
iirfiltsos_cccf_reset.restype = None
iirfiltsos_cccf_reset.argtypes = [iirfiltsos_cccf]
iirfiltsos_cccf_execute = _libraries['FIXME_STUB'].iirfiltsos_cccf_execute
...
iirfiltsos_cccf_execute_df1 = _libraries['FIXME_STUB'].iirfiltsos_cccf_execute_df1
...
iirfiltsos_cccf_execute_df2 = _libraries['FIXME_STUB'].iirfiltsos_cccf_execute_df2
...
iirfiltsos_cccf_groupdelay = _libraries['FIXME_STUB'].iirfiltsos_cccf_groupdelay
...
firpfb_rrrf_create = _libraries['FIXME_STUB'].firpfb_rrrf_create
...
firpfb_rrrf_create_default = _libraries['FIXME_STUB'].firpfb_rrrf_create_default
firpfb_rrrf_create_default.restype = firpfb_rrrf
firpfb_rrrf_create_default.argtypes = [ctypes.c_uint32, ctypes.c_uint32]
firpfb_rrrf_create_kaiser = _libraries['FIXME_STUB'].firpfb_rrrf_create_kaiser
...
firpfb_rrrf_create_rnyquist = _libraries['FIXME_STUB'].firpfb_rrrf_create_rnyquist
...
firpfb_rrrf_create_drnyquist = _libraries['FIXME_STUB'].firpfb_rrrf_create_drnyquist
...
firpfb_rrrf_recreate = _libraries['FIXME_STUB'].firpfb_rrrf_recreate
...
firpfb_crcf_create = _libraries['FIXME_STUB'].firpfb_crcf_create
...
firpfb_crcf_create_default = _libraries['FIXME_STUB'].firpfb_crcf_create_default
firpfb_crcf_create_default.restype = firpfb_crcf
firpfb_crcf_create_default.argtypes = [ctypes.c_uint32, ctypes.c_uint32]
firpfb_crcf_create_kaiser = _libraries['FIXME_STUB'].firpfb_crcf_create_kaiser
...
firpfb_crcf_create_rnyquist = _libraries['FIXME_STUB'].firpfb_crcf_create_rnyquist
...
firpfb_crcf_create_drnyquist = _libraries['FIXME_STUB'].firpfb_crcf_create_drnyquist
...
firpfb_crcf_recreate = _libraries['FIXME_STUB'].firpfb_crcf_recreate
...
firpfb_crcf_execute = _libraries['FIXME_STUB'].firpfb_crcf_execute
...
firpfb_crcf_execute_block = _libraries['FIXME_STUB'].firpfb_crcf_execute_block
...
firpfb_cccf_create = _libraries['FIXME_STUB'].firpfb_cccf_create
...
firpfb_cccf_create_default = _libraries['FIXME_STUB'].firpfb_cccf_create_default
firpfb_cccf_create_default.restype = firpfb_cccf
firpfb_cccf_create_default.argtypes = [ctypes.c_uint32, ctypes.c_uint32]
firpfb_cccf_create_kaiser = _libraries['FIXME_STUB'].firpfb_cccf_create_kaiser
...
firpfb_cccf_create_rnyquist = _libraries['FIXME_STUB'].firpfb_cccf_create_rnyquist
...
firpfb_cccf_create_drnyquist = _libraries['FIXME_STUB'].firpfb_cccf_create_drnyquist
...
firpfb_cccf_recreate = _libraries['FIXME_STUB'].firpfb_cccf_recreate
...
firpfb_cccf_destroy = _libraries['FIXME_STUB'].firpfb_cccf_destroy
firpfb_cccf_destroy.restype = None
firpfb_cccf_destroy.argtypes = [firpfb_cccf]
firpfb_cccf_print = _libraries['FIXME_STUB'].firpfb_cccf_print
firpfb_cccf_print.restype = None
firpfb_cccf_print.argtypes = [firpfb_cccf]
firpfb_cccf_set_scale = _libraries['FIXME_STUB'].firpfb_cccf_set_scale
firpfb_cccf_set_scale.restype = None
firpfb_cccf_set_scale.argtypes = [firpfb_cccf, liquid_float_complex]
firpfb_cccf_get_scale = _libraries['FIXME_STUB'].firpfb_cccf_get_scale
...
firpfb_cccf_reset = _libraries['FIXME_STUB'].firpfb_cccf_reset
firpfb_cccf_reset.restype = None
firpfb_cccf_reset.argtypes = [firpfb_cccf]
firpfb_cccf_push = _libraries['FIXME_STUB'].firpfb_cccf_push
firpfb_cccf_push.restype = None
firpfb_cccf_push.argtypes = [firpfb_cccf, liquid_float_complex]
firpfb_cccf_write = _libraries['FIXME_STUB'].firpfb_cccf_write
...
firpfb_cccf_execute = _libraries['FIXME_STUB'].firpfb_cccf_execute
...
firpfb_cccf_execute_block = _libraries['FIXME_STUB'].firpfb_cccf_execute_block
...
firinterp_rrrf_create = _libraries['FIXME_STUB'].firinterp_rrrf_create
...
firinterp_rrrf_create_kaiser = _libraries['FIXME_STUB'].firinterp_rrrf_create_kaiser
...
firinterp_rrrf_create_prototype = _libraries['FIXME_STUB'].firinterp_rrrf_create_prototype
...
firinterp_rrrf_execute_block = _libraries['FIXME_STUB'].firinterp_rrrf_execute_block
...
firinterp_crcf_create = _libraries['FIXME_STUB'].firinterp_crcf_create
...
firinterp_crcf_create_kaiser = _libraries['FIXME_STUB'].firinterp_crcf_create_kaiser
...
firinterp_crcf_create_prototype = _libraries['FIXME_STUB'].firinterp_crcf_create_prototype
...
firinterp_crcf_execute_block = _libraries['FIXME_STUB'].firinterp_crcf_execute_block
...
firinterp_cccf_create = _libraries['FIXME_STUB'].firinterp_cccf_create
...
firinterp_cccf_create_kaiser = _libraries['FIXME_STUB'].firinterp_cccf_create_kaiser
...
firinterp_cccf_create_prototype = _libraries['FIXME_STUB'].firinterp_cccf_create_prototype
...
firinterp_cccf_execute = _libraries['FIXME_STUB'].firinterp_cccf_execute
...
firinterp_cccf_execute_block = _libraries['FIXME_STUB'].firinterp_cccf_execute_block
...
iirinterp_rrrf_create = _libraries['FIXME_STUB'].iirinterp_rrrf_create
...
iirinterp_rrrf_create_default = _libraries['FIXME_STUB'].iirinterp_rrrf_create_default
...
iirinterp_rrrf_create_prototype = _libraries['FIXME_STUB'].iirinterp_rrrf_create_prototype
...
iirinterp_rrrf_destroy = _libraries['FIXME_STUB'].iirinterp_rrrf_destroy
iirinterp_rrrf_destroy.restype = None
iirinterp_rrrf_destroy.argtypes = [iirinterp_rrrf]
iirinterp_rrrf_print = _libraries['FIXME_STUB'].iirinterp_rrrf_print
iirinterp_rrrf_print.restype = None
iirinterp_rrrf_print.argtypes = [iirinterp_rrrf]
iirinterp_rrrf_reset = _libraries['FIXME_STUB'].iirinterp_rrrf_reset
iirinterp_rrrf_reset.restype = None
iirinterp_rrrf_reset.argtypes = [iirinterp_rrrf]
iirinterp_rrrf_execute = _libraries['FIXME_STUB'].iirinterp_rrrf_execute
...
iirinterp_rrrf_execute_block = _libraries['FIXME_STUB'].iirinterp_rrrf_execute_block
...
iirinterp_rrrf_groupdelay = _libraries['FIXME_STUB'].iirinterp_rrrf_groupdelay
...
iirinterp_crcf_create = _libraries['FIXME_STUB'].iirinterp_crcf_create
...
iirinterp_crcf_create_default = _libraries['FIXME_STUB'].iirinterp_crcf_create_default
...
iirinterp_crcf_create_prototype = _libraries['FIXME_STUB'].iirinterp_crcf_create_prototype
...
iirinterp_crcf_destroy = _libraries['FIXME_STUB'].iirinterp_crcf_destroy
iirinterp_crcf_destroy.restype = None
iirinterp_crcf_destroy.argtypes = [iirinterp_crcf]
iirinterp_crcf_print = _libraries['FIXME_STUB'].iirinterp_crcf_print
iirinterp_crcf_print.restype = None
iirinterp_crcf_print.argtypes = [iirinterp_crcf]
iirinterp_crcf_reset = _libraries['FIXME_STUB'].iirinterp_crcf_reset
iirinterp_crcf_reset.restype = None
iirinterp_crcf_reset.argtypes = [iirinterp_crcf]
iirinterp_crcf_execute = _libraries['FIXME_STUB'].iirinterp_crcf_execute
...
iirinterp_crcf_execute_block = _libraries['FIXME_STUB'].iirinterp_crcf_execute_block
...
iirinterp_crcf_groupdelay = _libraries['FIXME_STUB'].iirinterp_crcf_groupdelay
...
iirinterp_cccf_create = _libraries['FIXME_STUB'].iirinterp_cccf_create
...
iirinterp_cccf_create_default = _libraries['FIXME_STUB'].iirinterp_cccf_create_default
...
iirinterp_cccf_create_prototype = _libraries['FIXME_STUB'].iirinterp_cccf_create_prototype
...
iirinterp_cccf_destroy = _libraries['FIXME_STUB'].iirinterp_cccf_destroy
iirinterp_cccf_destroy.restype = None
iirinterp_cccf_destroy.argtypes = [iirinterp_cccf]
iirinterp_cccf_print = _libraries['FIXME_STUB'].iirinterp_cccf_print
iirinterp_cccf_print.restype = None
iirinterp_cccf_print.argtypes = [iirinterp_cccf]
iirinterp_cccf_reset = _libraries['FIXME_STUB'].iirinterp_cccf_reset
iirinterp_cccf_reset.restype = None
iirinterp_cccf_reset.argtypes = [iirinterp_cccf]
iirinterp_cccf_execute = _libraries['FIXME_STUB'].iirinterp_cccf_execute
...
iirinterp_cccf_execute_block = _libraries['FIXME_STUB'].iirinterp_cccf_execute_block
...
iirinterp_cccf_groupdelay = _libraries['FIXME_STUB'].iirinterp_cccf_groupdelay
...
firdecim_rrrf_create = _libraries['FIXME_STUB'].firdecim_rrrf_create
...
firdecim_rrrf_create_kaiser = _libraries['FIXME_STUB'].firdecim_rrrf_create_kaiser
...
firdecim_rrrf_create_prototype = _libraries['FIXME_STUB'].firdecim_rrrf_create_prototype
...
firdecim_rrrf_execute_block = _libraries['FIXME_STUB'].firdecim_rrrf_execute_block
...
firdecim_crcf_create = _libraries['FIXME_STUB'].firdecim_crcf_create
...
firdecim_crcf_create_kaiser = _libraries['FIXME_STUB'].firdecim_crcf_create_kaiser
...
firdecim_crcf_create_prototype = _libraries['FIXME_STUB'].firdecim_crcf_create_prototype
...
firdecim_crcf_execute_block = _libraries['FIXME_STUB'].firdecim_crcf_execute_block
...
firdecim_cccf_create = _libraries['FIXME_STUB'].firdecim_cccf_create
...
firdecim_cccf_create_kaiser = _libraries['FIXME_STUB'].firdecim_cccf_create_kaiser
...
firdecim_cccf_create_prototype = _libraries['FIXME_STUB'].firdecim_cccf_create_prototype
...
firdecim_cccf_execute = _libraries['FIXME_STUB'].firdecim_cccf_execute
...
firdecim_cccf_execute_block = _libraries['FIXME_STUB'].firdecim_cccf_execute_block
...
iirdecim_rrrf_create = _libraries['FIXME_STUB'].iirdecim_rrrf_create
...
iirdecim_rrrf_create_default = _libraries['FIXME_STUB'].iirdecim_rrrf_create_default
iirdecim_rrrf_create_default.restype = iirdecim_rrrf
iirdecim_rrrf_create_default.argtypes = [ctypes.c_uint32, ctypes.c_uint32]
iirdecim_rrrf_create_prototype = _libraries['FIXME_STUB'].iirdecim_rrrf_create_prototype
...
iirdecim_rrrf_destroy = _libraries['FIXME_STUB'].iirdecim_rrrf_destroy
iirdecim_rrrf_destroy.restype = None
iirdecim_rrrf_destroy.argtypes = [iirdecim_rrrf]
iirdecim_rrrf_print = _libraries['FIXME_STUB'].iirdecim_rrrf_print
iirdecim_rrrf_print.restype = None
iirdecim_rrrf_print.argtypes = [iirdecim_rrrf]
iirdecim_rrrf_reset = _libraries['FIXME_STUB'].iirdecim_rrrf_reset
iirdecim_rrrf_reset.restype = None
iirdecim_rrrf_reset.argtypes = [iirdecim_rrrf]
iirdecim_rrrf_execute = _libraries['FIXME_STUB'].iirdecim_rrrf_execute
...
iirdecim_rrrf_execute_block = _libraries['FIXME_STUB'].iirdecim_rrrf_execute_block
...
iirdecim_rrrf_groupdelay = _libraries['FIXME_STUB'].iirdecim_rrrf_groupdelay
...
iirdecim_crcf_create = _libraries['FIXME_STUB'].iirdecim_crcf_create
...
iirdecim_crcf_create_default = _libraries['FIXME_STUB'].iirdecim_crcf_create_default
iirdecim_crcf_create_default.restype = iirdecim_crcf
iirdecim_crcf_create_default.argtypes = [ctypes.c_uint32, ctypes.c_uint32]
iirdecim_crcf_create_prototype = _libraries['FIXME_STUB'].iirdecim_crcf_create_prototype
...
iirdecim_crcf_destroy = _libraries['FIXME_STUB'].iirdecim_crcf_destroy
iirdecim_crcf_destroy.restype = None
iirdecim_crcf_destroy.argtypes = [iirdecim_crcf]
iirdecim_crcf_print = _libraries['FIXME_STUB'].iirdecim_crcf_print
iirdecim_crcf_print.restype = None
iirdecim_crcf_print.argtypes = [iirdecim_crcf]
iirdecim_crcf_reset = _libraries['FIXME_STUB'].iirdecim_crcf_reset
iirdecim_crcf_reset.restype = None
iirdecim_crcf_reset.argtypes = [iirdecim_crcf]
iirdecim_crcf_execute = _libraries['FIXME_STUB'].iirdecim_crcf_execute
...
iirdecim_crcf_execute_block = _libraries['FIXME_STUB'].iirdecim_crcf_execute_block
...
iirdecim_crcf_groupdelay = _libraries['FIXME_STUB'].iirdecim_crcf_groupdelay
...
iirdecim_cccf_create = _libraries['FIXME_STUB'].iirdecim_cccf_create
...
iirdecim_cccf_create_default = _libraries['FIXME_STUB'].iirdecim_cccf_create_default
iirdecim_cccf_create_default.restype = iirdecim_cccf
iirdecim_cccf_create_default.argtypes = [ctypes.c_uint32, ctypes.c_uint32]
iirdecim_cccf_create_prototype = _libraries['FIXME_STUB'].iirdecim_cccf_create_prototype
...
iirdecim_cccf_destroy = _libraries['FIXME_STUB'].iirdecim_cccf_destroy
iirdecim_cccf_destroy.restype = None
iirdecim_cccf_destroy.argtypes = [iirdecim_cccf]
iirdecim_cccf_print = _libraries['FIXME_STUB'].iirdecim_cccf_print
iirdecim_cccf_print.restype = None
iirdecim_cccf_print.argtypes = [iirdecim_cccf]
iirdecim_cccf_reset = _libraries['FIXME_STUB'].iirdecim_cccf_reset
iirdecim_cccf_reset.restype = None
iirdecim_cccf_reset.argtypes = [iirdecim_cccf]
iirdecim_cccf_execute = _libraries['FIXME_STUB'].iirdecim_cccf_execute
...
iirdecim_cccf_execute_block = _libraries['FIXME_STUB'].iirdecim_cccf_execute_block
...
iirdecim_cccf_groupdelay = _libraries['FIXME_STUB'].iirdecim_cccf_groupdelay
...
resamp2_rrrf_create = _libraries['FIXME_STUB'].resamp2_rrrf_create
resamp2_rrrf_create.restype = resamp2_rrrf
resamp2_rrrf_create.argtypes = [ctypes.c_uint32, ctypes.c_float, ctypes.c_float]
resamp2_rrrf_recreate = _libraries['FIXME_STUB'].resamp2_rrrf_recreate
...
resamp2_rrrf_destroy = _libraries['FIXME_STUB'].resamp2_rrrf_destroy
resamp2_rrrf_destroy.restype = None
resamp2_rrrf_destroy.argtypes = [resamp2_rrrf]
resamp2_rrrf_print = _libraries['FIXME_STUB'].resamp2_rrrf_print
resamp2_rrrf_print.restype = None
resamp2_rrrf_print.argtypes = [resamp2_rrrf]
resamp2_rrrf_reset = _libraries['FIXME_STUB'].resamp2_rrrf_reset
resamp2_rrrf_reset.restype = None
resamp2_rrrf_reset.argtypes = [resamp2_rrrf]
resamp2_rrrf_get_delay = _libraries['FIXME_STUB'].resamp2_rrrf_get_delay
resamp2_rrrf_get_delay.restype = ctypes.c_uint32
resamp2_rrrf_get_delay.argtypes = [resamp2_rrrf]
resamp2_rrrf_filter_execute = _libraries['FIXME_STUB'].resamp2_rrrf_filter_execute
...
resamp2_rrrf_analyzer_execute = _libraries['FIXME_STUB'].resamp2_rrrf_analyzer_execute
...
resamp2_rrrf_synthesizer_execute = _libraries['FIXME_STUB'].resamp2_rrrf_synthesizer_execute
...
resamp2_rrrf_decim_execute = _libraries['FIXME_STUB'].resamp2_rrrf_decim_execute
...
resamp2_rrrf_interp_execute = _libraries['FIXME_STUB'].resamp2_rrrf_interp_execute
...
resamp2_crcf_create = _libraries['FIXME_STUB'].resamp2_crcf_create
resamp2_crcf_create.restype = resamp2_crcf
resamp2_crcf_create.argtypes = [ctypes.c_uint32, ctypes.c_float, ctypes.c_float]
resamp2_crcf_recreate = _libraries['FIXME_STUB'].resamp2_crcf_recreate
...
resamp2_crcf_destroy = _libraries['FIXME_STUB'].resamp2_crcf_destroy
resamp2_crcf_destroy.restype = None
resamp2_crcf_destroy.argtypes = [resamp2_crcf]
resamp2_crcf_print = _libraries['FIXME_STUB'].resamp2_crcf_print
resamp2_crcf_print.restype = None
resamp2_crcf_print.argtypes = [resamp2_crcf]
resamp2_crcf_reset = _libraries['FIXME_STUB'].resamp2_crcf_reset
resamp2_crcf_reset.restype = None
resamp2_crcf_reset.argtypes = [resamp2_crcf]
resamp2_crcf_get_delay = _libraries['FIXME_STUB'].resamp2_crcf_get_delay
resamp2_crcf_get_delay.restype = ctypes.c_uint32
resamp2_crcf_get_delay.argtypes = [resamp2_crcf]
resamp2_crcf_filter_execute = _libraries['FIXME_STUB'].resamp2_crcf_filter_execute
...
resamp2_crcf_analyzer_execute = _libraries['FIXME_STUB'].resamp2_crcf_analyzer_execute
...
resamp2_crcf_synthesizer_execute = _libraries['FIXME_STUB'].resamp2_crcf_synthesizer_execute
...
resamp2_crcf_decim_execute = _libraries['FIXME_STUB'].resamp2_crcf_decim_execute
...
resamp2_crcf_interp_execute = _libraries['FIXME_STUB'].resamp2_crcf_interp_execute
...
resamp2_cccf_create = _libraries['FIXME_STUB'].resamp2_cccf_create
resamp2_cccf_create.restype = resamp2_cccf
resamp2_cccf_create.argtypes = [ctypes.c_uint32, ctypes.c_float, ctypes.c_float]
resamp2_cccf_recreate = _libraries['FIXME_STUB'].resamp2_cccf_recreate
...
resamp2_cccf_destroy = _libraries['FIXME_STUB'].resamp2_cccf_destroy
resamp2_cccf_destroy.restype = None
resamp2_cccf_destroy.argtypes = [resamp2_cccf]
resamp2_cccf_print = _libraries['FIXME_STUB'].resamp2_cccf_print
resamp2_cccf_print.restype = None
resamp2_cccf_print.argtypes = [resamp2_cccf]
resamp2_cccf_reset = _libraries['FIXME_STUB'].resamp2_cccf_reset
resamp2_cccf_reset.restype = None
resamp2_cccf_reset.argtypes = [resamp2_cccf]
resamp2_cccf_get_delay = _libraries['FIXME_STUB'].resamp2_cccf_get_delay
resamp2_cccf_get_delay.restype = ctypes.c_uint32
resamp2_cccf_get_delay.argtypes = [resamp2_cccf]
resamp2_cccf_filter_execute = _libraries['FIXME_STUB'].resamp2_cccf_filter_execute
...
resamp2_cccf_analyzer_execute = _libraries['FIXME_STUB'].resamp2_cccf_analyzer_execute
...
resamp2_cccf_synthesizer_execute = _libraries['FIXME_STUB'].resamp2_cccf_synthesizer_execute
...
resamp2_cccf_decim_execute = _libraries['FIXME_STUB'].resamp2_cccf_decim_execute
...
resamp2_cccf_interp_execute = _libraries['FIXME_STUB'].resamp2_cccf_interp_execute
...
rresamp_rrrf_create = _libraries['FIXME_STUB'].rresamp_rrrf_create
...
rresamp_rrrf_create_kaiser = _libraries['FIXME_STUB'].rresamp_rrrf_create_kaiser
...
rresamp_rrrf_create_prototype = _libraries['FIXME_STUB'].rresamp_rrrf_create_prototype
...
rresamp_rrrf_execute_block = _libraries['FIXME_STUB'].rresamp_rrrf_execute_block
...
rresamp_crcf_create = _libraries['FIXME_STUB'].rresamp_crcf_create
...
rresamp_crcf_create_kaiser = _libraries['FIXME_STUB'].rresamp_crcf_create_kaiser
...
rresamp_crcf_create_prototype = _libraries['FIXME_STUB'].rresamp_crcf_create_prototype
...
rresamp_crcf_execute_block = _libraries['FIXME_STUB'].rresamp_crcf_execute_block
...
rresamp_cccf_create = _libraries['FIXME_STUB'].rresamp_cccf_create
...
rresamp_cccf_create_kaiser = _libraries['FIXME_STUB'].rresamp_cccf_create_kaiser
...
rresamp_cccf_create_prototype = _libraries['FIXME_STUB'].rresamp_cccf_create_prototype
...
rresamp_cccf_execute_block = _libraries['FIXME_STUB'].rresamp_cccf_execute_block
...
resamp_rrrf_create = _libraries['FIXME_STUB'].resamp_rrrf_create
...
resamp_rrrf_execute_block = _libraries['FIXME_STUB'].resamp_rrrf_execute_block
...
resamp_crcf_create = _libraries['FIXME_STUB'].resamp_crcf_create
...
resamp_crcf_execute_block = _libraries['FIXME_STUB'].resamp_crcf_execute_block
...
resamp_cccf_create = _libraries['FIXME_STUB'].resamp_cccf_create
...
resamp_cccf_execute_block = _libraries['FIXME_STUB'].resamp_cccf_execute_block
...
msresamp2_rrrf_create = _libraries['FIXME_STUB'].msresamp2_rrrf_create
...
msresamp2_crcf_create = _libraries['FIXME_STUB'].msresamp2_crcf_create
...
msresamp2_cccf_create = _libraries['FIXME_STUB'].msresamp2_cccf_create
...
dds_cccf_interp_execute = _libraries['FIXME_STUB'].dds_cccf_interp_execute
...
symsync_rrrf_create = _libraries['FIXME_STUB'].symsync_rrrf_create
...
symsync_rrrf_create_rnyquist = _libraries['FIXME_STUB'].symsync_rrrf_create_rnyquist
...
symsync_rrrf_create_kaiser = _libraries['FIXME_STUB'].symsync_rrrf_create_kaiser
...
symsync_crcf_create = _libraries['FIXME_STUB'].symsync_crcf_create
...
symsync_crcf_create_rnyquist = _libraries['FIXME_STUB'].symsync_crcf_create_rnyquist
...
symsync_crcf_create_kaiser = _libraries['FIXME_STUB'].symsync_crcf_create_kaiser
...
firfarrow_rrrf_create = _libraries['FIXME_STUB'].firfarrow_rrrf_create
...
firfarrow_rrrf_get_length = _libraries['FIXME_STUB'].firfarrow_rrrf_get_length
firfarrow_rrrf_get_length.restype = ctypes.c_uint32
firfarrow_rrrf_get_length.argtypes = [firfarrow_rrrf]
firfarrow_rrrf_get_coefficients = _libraries['FIXME_STUB'].firfarrow_rrrf_get_coefficients
...
firfarrow_rrrf_freqresponse = _libraries['FIXME_STUB'].firfarrow_rrrf_freqresponse
...
firfarrow_rrrf_groupdelay = _libraries['FIXME_STUB'].firfarrow_rrrf_groupdelay
...
firfarrow_crcf_create = _libraries['FIXME_STUB'].firfarrow_crcf_create
...
firfarrow_crcf_execute_block = _libraries['FIXME_STUB'].firfarrow_crcf_execute_block
...
firfarrow_crcf_get_length = _libraries['FIXME_STUB'].firfarrow_crcf_get_length
firfarrow_crcf_get_length.restype = ctypes.c_uint32
firfarrow_crcf_get_length.argtypes = [firfarrow_crcf]
firfarrow_crcf_get_coefficients = _libraries['FIXME_STUB'].firfarrow_crcf_get_coefficients
...
firfarrow_crcf_freqresponse = _libraries['FIXME_STUB'].firfarrow_crcf_freqresponse
...
firfarrow_crcf_groupdelay = _libraries['FIXME_STUB'].firfarrow_crcf_groupdelay
...
framesyncstats_init_default = _libraries['FIXME_STUB'].framesyncstats_init_default
...
framesyncstats_print = _libraries['FIXME_STUB'].framesyncstats_print
...
framedatastats_reset = _libraries['FIXME_STUB'].framedatastats_reset
framedatastats_reset.restype = ctypes.c_int32
framedatastats_reset.argtypes = [ctypes.POINTER(struct_c__SA_framedatastats_s)]
framedatastats_print = _libraries['FIXME_STUB'].framedatastats_print
...
qpacketmodem_get_demodulator_evm = _libraries['FIXME_STUB'].qpacketmodem_get_demodulator_evm
qpacketmodem_get_demodulator_evm.restype = ctypes.c_float
qpacketmodem_get_demodulator_evm.argtypes = [qpacketmodem]
qpacketmodem_encode_syms = _libraries['FIXME_STUB'].qpacketmodem_encode_syms
...
qpacketmodem_decode_syms = _libraries['FIXME_STUB'].qpacketmodem_decode_syms
...
qpacketmodem_decode_bits = _libraries['FIXME_STUB'].qpacketmodem_decode_bits
...
qpacketmodem_encode = _libraries['FIXME_STUB'].qpacketmodem_encode
...
qpacketmodem_decode = _libraries['FIXME_STUB'].qpacketmodem_decode
...
qpacketmodem_decode_soft = _libraries['FIXME_STUB'].qpacketmodem_decode_soft
...
qpacketmodem_decode_soft_sym = _libraries['FIXME_STUB'].qpacketmodem_decode_soft_sym
...
qpacketmodem_decode_soft_payload = _libraries['FIXME_STUB'].qpacketmodem_decode_soft_payload
...
qpilot_num_pilots = _libraries['FIXME_STUB'].qpilot_num_pilots
qpilot_num_pilots.restype = ctypes.c_uint32
qpilot_num_pilots.argtypes = [ctypes.c_uint32, ctypes.c_uint32]
qpilot_frame_len = _libraries['FIXME_STUB'].qpilot_frame_len
...
framegen64_create = _libraries['FIXME_STUB'].framegen64_create
framegen64_create.restype = framegen64
framegen64_create.argtypes = []
framegen64_destroy = _libraries['FIXME_STUB'].framegen64_destroy
framegen64_destroy.restype = ctypes.c_int32
framegen64_destroy.argtypes = [framegen64]
framegen64_print = _libraries['FIXME_STUB'].framegen64_print
framegen64_print.restype = ctypes.c_int32
framegen64_print.argtypes = [framegen64]
framegen64_execute = _libraries['FIXME_STUB'].framegen64_execute
...
flexframegenprops_init_default = _libraries['FIXME_STUB'].flexframegenprops_init_default
...
flexframegen_setprops = _libraries['FIXME_STUB'].flexframegen_setprops
...
flexframegen_set_header_len = _libraries['FIXME_STUB'].flexframegen_set_header_len
flexframegen_set_header_len.restype = ctypes.c_int32
flexframegen_set_header_len.argtypes = [flexframegen, ctypes.c_uint32]
flexframegen_set_header_props = _libraries['FIXME_STUB'].flexframegen_set_header_props
...
flexframegen_getframelen = _libraries['FIXME_STUB'].flexframegen_getframelen
flexframegen_getframelen.restype = ctypes.c_uint32
flexframegen_getframelen.argtypes = [flexframegen]
flexframegen_assemble = _libraries['FIXME_STUB'].flexframegen_assemble
...
flexframegen_write_samples = _libraries['FIXME_STUB'].flexframegen_write_samples
...
flexframesync_decode_payload_soft = _libraries['FIXME_STUB'].flexframesync_decode_payload_soft
...
flexframesync_set_header_props = _libraries['FIXME_STUB'].flexframesync_set_header_props
...
flexframesync_execute = _libraries['FIXME_STUB'].flexframesync_execute
...
bpacketgen_create = _libraries['FIXME_STUB'].bpacketgen_create
...
bpacketgen_recreate = _libraries['FIXME_STUB'].bpacketgen_recreate
...
bpacketgen_destroy = _libraries['FIXME_STUB'].bpacketgen_destroy
bpacketgen_destroy.restype = None
bpacketgen_destroy.argtypes = [bpacketgen]
bpacketgen_print = _libraries['FIXME_STUB'].bpacketgen_print
bpacketgen_print.restype = None
bpacketgen_print.argtypes = [bpacketgen]
bpacketgen_get_packet_len = _libraries['FIXME_STUB'].bpacketgen_get_packet_len
bpacketgen_get_packet_len.restype = ctypes.c_uint32
bpacketgen_get_packet_len.argtypes = [bpacketgen]
bpacketgen_encode = _libraries['FIXME_STUB'].bpacketgen_encode
...
bpacketsync_create = _libraries['FIXME_STUB'].bpacketsync_create
...
bpacketsync_execute_byte = _libraries['FIXME_STUB'].bpacketsync_execute_byte
bpacketsync_execute_byte.restype = ctypes.c_int32
bpacketsync_execute_byte.argtypes = [bpacketsync, ctypes.c_ubyte]
bpacketsync_execute_sym = _libraries['FIXME_STUB'].bpacketsync_execute_sym
...
bpacketsync_execute_bit = _libraries['FIXME_STUB'].bpacketsync_execute_bit
...
fskframegen_getframelen = _libraries['FIXME_STUB'].fskframegen_getframelen
fskframegen_getframelen.restype = ctypes.c_uint32
fskframegen_getframelen.argtypes = [fskframegen]
fskframegen_write_samples = _libraries['FIXME_STUB'].fskframegen_write_samples
...
fskframesync_debug_enable = _libraries['FIXME_STUB'].fskframesync_debug_enable
fskframesync_debug_enable.restype = ctypes.c_int32
fskframesync_debug_enable.argtypes = [fskframesync]
fskframesync_debug_disable = _libraries['FIXME_STUB'].fskframesync_debug_disable
fskframesync_debug_disable.restype = ctypes.c_int32
fskframesync_debug_disable.argtypes = [fskframesync]
fskframesync_debug_export = _libraries['FIXME_STUB'].fskframesync_debug_export
...
gmskframegen_getframelen = _libraries['FIXME_STUB'].gmskframegen_getframelen
gmskframegen_getframelen.restype = ctypes.c_uint32
gmskframegen_getframelen.argtypes = [gmskframegen]
gmskframegen_write_samples = _libraries['FIXME_STUB'].gmskframegen_write_samples
...
gmskframegen_write = _libraries['FIXME_STUB'].gmskframegen_write
...
gmskframesync_create = _libraries['FIXME_STUB'].gmskframesync_create
...
dsssframegen_setprops = _libraries['FIXME_STUB'].dsssframegen_setprops
...
dsssframegen_set_header_len = _libraries['FIXME_STUB'].dsssframegen_set_header_len
dsssframegen_set_header_len.restype = ctypes.c_int32
dsssframegen_set_header_len.argtypes = [dsssframegen, ctypes.c_uint32]
dsssframegen_set_header_props = _libraries['FIXME_STUB'].dsssframegen_set_header_props
...
dsssframegen_getframelen = _libraries['FIXME_STUB'].dsssframegen_getframelen
dsssframegen_getframelen.restype = ctypes.c_uint32
dsssframegen_getframelen.argtypes = [dsssframegen]
dsssframegen_assemble = _libraries['FIXME_STUB'].dsssframegen_assemble
...
dsssframegen_write_samples = _libraries['FIXME_STUB'].dsssframegen_write_samples
...
dsssframesync_decode_payload_soft = _libraries['FIXME_STUB'].dsssframesync_decode_payload_soft
...
dsssframesync_set_header_props = _libraries['FIXME_STUB'].dsssframesync_set_header_props
...
dsssframesync_execute = _libraries['FIXME_STUB'].dsssframesync_execute
...
dsssframesync_reset_framedatastats = _libraries['FIXME_STUB'].dsssframesync_reset_framedatastats
dsssframesync_reset_framedatastats.restype = ctypes.c_int32
dsssframesync_reset_framedatastats.argtypes = [dsssframesync]
dsssframesync_debug_enable = _libraries['FIXME_STUB'].dsssframesync_debug_enable
dsssframesync_debug_enable.restype = ctypes.c_int32
dsssframesync_debug_enable.argtypes = [dsssframesync]
dsssframesync_debug_disable = _libraries['FIXME_STUB'].dsssframesync_debug_disable
dsssframesync_debug_disable.restype = ctypes.c_int32
dsssframesync_debug_disable.argtypes = [dsssframesync]
dsssframesync_debug_print = _libraries['FIXME_STUB'].dsssframesync_debug_print
...
dsssframesync_get_framedatastats = _libraries['FIXME_STUB'].dsssframesync_get_framedatastats
...
ofdmflexframegenprops_init_default = _libraries['FIXME_STUB'].ofdmflexframegenprops_init_default
...
ofdmflexframegen_create = _libraries['FIXME_STUB'].ofdmflexframegen_create
...
ofdmflexframegen_setprops = _libraries['FIXME_STUB'].ofdmflexframegen_setprops
...
ofdmflexframegen_set_header_len = _libraries['FIXME_STUB'].ofdmflexframegen_set_header_len
...
ofdmflexframegen_set_header_props = _libraries['FIXME_STUB'].ofdmflexframegen_set_header_props
...
ofdmflexframegen_getframelen = _libraries['FIXME_STUB'].ofdmflexframegen_getframelen
ofdmflexframegen_getframelen.restype = ctypes.c_uint32
ofdmflexframegen_getframelen.argtypes = [ofdmflexframegen]
ofdmflexframegen_assemble = _libraries['FIXME_STUB'].ofdmflexframegen_assemble
...
ofdmflexframegen_write = _libraries['FIXME_STUB'].ofdmflexframegen_write
...
ofdmflexframesync_create = _libraries['FIXME_STUB'].ofdmflexframesync_create
...
ofdmflexframesync_destroy = _libraries['FIXME_STUB'].ofdmflexframesync_destroy
ofdmflexframesync_destroy.restype = ctypes.c_int32
ofdmflexframesync_destroy.argtypes = [ofdmflexframesync]
ofdmflexframesync_print = _libraries['FIXME_STUB'].ofdmflexframesync_print
ofdmflexframesync_print.restype = ctypes.c_int32
ofdmflexframesync_print.argtypes = [ofdmflexframesync]
ofdmflexframesync_set_header_len = _libraries['FIXME_STUB'].ofdmflexframesync_set_header_len
...
ofdmflexframesync_decode_header_soft = _libraries['FIXME_STUB'].ofdmflexframesync_decode_header_soft
...
ofdmflexframesync_decode_payload_soft = _libraries['FIXME_STUB'].ofdmflexframesync_decode_payload_soft
...
ofdmflexframesync_set_header_props = _libraries['FIXME_STUB'].ofdmflexframesync_set_header_props
...
ofdmflexframesync_reset = _libraries['FIXME_STUB'].ofdmflexframesync_reset
ofdmflexframesync_reset.restype = ctypes.c_int32
ofdmflexframesync_reset.argtypes = [ofdmflexframesync]
ofdmflexframesync_is_frame_open = _libraries['FIXME_STUB'].ofdmflexframesync_is_frame_open
ofdmflexframesync_is_frame_open.restype = ctypes.c_int32
ofdmflexframesync_is_frame_open.argtypes = [ofdmflexframesync]
ofdmflexframesync_execute = _libraries['FIXME_STUB'].ofdmflexframesync_execute
...
ofdmflexframesync_get_rssi = _libraries['FIXME_STUB'].ofdmflexframesync_get_rssi
ofdmflexframesync_get_rssi.restype = ctypes.c_float
ofdmflexframesync_get_rssi.argtypes = [ofdmflexframesync]
ofdmflexframesync_get_cfo = _libraries['FIXME_STUB'].ofdmflexframesync_get_cfo
ofdmflexframesync_get_cfo.restype = ctypes.c_float
ofdmflexframesync_get_cfo.argtypes = [ofdmflexframesync]
ofdmflexframesync_reset_framedatastats = _libraries['FIXME_STUB'].ofdmflexframesync_reset_framedatastats
...
ofdmflexframesync_get_framedatastats = _libraries['FIXME_STUB'].ofdmflexframesync_get_framedatastats
...
bsync_cccf_create = _libraries['FIXME_STUB'].bsync_cccf_create
...
bsync_cccf_create_msequence = _libraries['FIXME_STUB'].bsync_cccf_create_msequence
bsync_cccf_create_msequence.restype = bsync_cccf
bsync_cccf_create_msequence.argtypes = [ctypes.c_uint32, ctypes.c_uint32]
bsync_cccf_destroy = _libraries['FIXME_STUB'].bsync_cccf_destroy
bsync_cccf_destroy.restype = None
bsync_cccf_destroy.argtypes = [bsync_cccf]
bsync_cccf_print = _libraries['FIXME_STUB'].bsync_cccf_print
bsync_cccf_print.restype = None
bsync_cccf_print.argtypes = [bsync_cccf]
bsync_cccf_correlate = _libraries['FIXME_STUB'].bsync_cccf_correlate
...
presync_cccf_create = _libraries['FIXME_STUB'].presync_cccf_create
...
bpresync_cccf_create = _libraries['FIXME_STUB'].bpresync_cccf_create
...
qdetector_cccf_create = _libraries['FIXME_STUB'].qdetector_cccf_create
...
qdetector_cccf_create_linear = _libraries['FIXME_STUB'].qdetector_cccf_create_linear
...
qdetector_cccf_create_gmsk = _libraries['FIXME_STUB'].qdetector_cccf_create_gmsk
...
qdetector_cccf_create_cpfsk = _libraries['FIXME_STUB'].qdetector_cccf_create_cpfsk
...
detector_cccf_create = _libraries['FIXME_STUB'].detector_cccf_create
...
detector_cccf_destroy = _libraries['FIXME_STUB'].detector_cccf_destroy
detector_cccf_destroy.restype = None
detector_cccf_destroy.argtypes = [detector_cccf]
detector_cccf_print = _libraries['FIXME_STUB'].detector_cccf_print
detector_cccf_print.restype = None
detector_cccf_print.argtypes = [detector_cccf]
detector_cccf_reset = _libraries['FIXME_STUB'].detector_cccf_reset
detector_cccf_reset.restype = None
detector_cccf_reset.argtypes = [detector_cccf]
detector_cccf_correlate = _libraries['FIXME_STUB'].detector_cccf_correlate
...
symstreamcf_create = _libraries['FIXME_STUB'].symstreamcf_create
symstreamcf_create.restype = symstreamcf
symstreamcf_create.argtypes = []
symstreamcf_create_linear = _libraries['FIXME_STUB'].symstreamcf_create_linear
...
symstreamrcf_create = _libraries['FIXME_STUB'].symstreamrcf_create
symstreamrcf_create.restype = symstreamrcf
symstreamrcf_create.argtypes = []
symstreamrcf_create_linear = _libraries['FIXME_STUB'].symstreamrcf_create_linear
...
msourcecf_add_user = _libraries['FIXME_STUB'].msourcecf_add_user
...
msourcecf_add_tone = _libraries['FIXME_STUB'].msourcecf_add_tone
...
msourcecf_add_chirp = _libraries['FIXME_STUB'].msourcecf_add_chirp
...
msourcecf_add_noise = _libraries['FIXME_STUB'].msourcecf_add_noise
...
msourcecf_add_modem = _libraries['FIXME_STUB'].msourcecf_add_modem
...
msourcecf_add_fsk = _libraries['FIXME_STUB'].msourcecf_add_fsk
...
msourcecf_add_gmsk = _libraries['FIXME_STUB'].msourcecf_add_gmsk
...
msourcecf_get_num_samples = _libraries['FIXME_STUB'].msourcecf_get_num_samples
msourcecf_get_num_samples.restype = ctypes.c_uint64
msourcecf_get_num_samples.argtypes = [msourcecf]
msourcecf_set_frequency = _libraries['FIXME_STUB'].msourcecf_set_frequency
msourcecf_set_frequency.restype = ctypes.c_int32
msourcecf_set_frequency.argtypes = [msourcecf, ctypes.c_int32, ctypes.c_float]
msourcecf_get_frequency = _libraries['FIXME_STUB'].msourcecf_get_frequency
...
msourcecf_write_samples = _libraries['FIXME_STUB'].msourcecf_write_samples
...
symtrack_rrrf_create = _libraries['FIXME_STUB'].symtrack_rrrf_create
...
symtrack_rrrf_execute_block = _libraries['FIXME_STUB'].symtrack_rrrf_execute_block
...
symtrack_cccf_create = _libraries['FIXME_STUB'].symtrack_cccf_create
...
symtrack_cccf_execute_block = _libraries['FIXME_STUB'].symtrack_cccf_execute_block
...
liquid_print_windows = _libraries['FIXME_STUB'].liquid_print_windows
liquid_print_windows.restype = None
liquid_print_windows.argtypes = []
liquid_getopt_str2window = _libraries['FIXME_STUB'].liquid_getopt_str2window
liquid_getopt_str2window.restype = liquid_window_type
liquid_getopt_str2window.argtypes = [ctypes.POINTER(ctypes.c_char)]
liquid_windowf = _libraries['FIXME_STUB'].liquid_windowf
...
liquid_kbd = _libraries['FIXME_STUB'].liquid_kbd
liquid_kbd.restype = ctypes.c_float
liquid_kbd.argtypes = [ctypes.c_uint32, ctypes.c_uint32, ctypes.c_float]
liquid_kbd_window = _libraries['FIXME_STUB'].liquid_kbd_window
...
poly_fit_lagrange = _libraries['FIXME_STUB'].poly_fit_lagrange
...
poly_interp_lagrange = _libraries['FIXME_STUB'].poly_interp_lagrange
...
poly_fit_lagrange_barycentric = _libraries['FIXME_STUB'].poly_fit_lagrange_barycentric
...
poly_val_lagrange_barycentric = _libraries['FIXME_STUB'].poly_val_lagrange_barycentric
...
poly_expandbinomial = _libraries['FIXME_STUB'].poly_expandbinomial
poly_expandbinomial.restype = ctypes.c_int32
poly_expandbinomial.argtypes = [ctypes.c_uint32, ctypes.POINTER(ctypes.c_double)]
poly_expandbinomial_pm = _libraries['FIXME_STUB'].poly_expandbinomial_pm
...
poly_expandroots = _libraries['FIXME_STUB'].poly_expandroots
...
poly_expandroots2 = _libraries['FIXME_STUB'].poly_expandroots2
...
poly_findroots = _libraries['FIXME_STUB'].poly_findroots
...
poly_findroots_durandkerner = _libraries['FIXME_STUB'].poly_findroots_durandkerner
...
poly_findroots_bairstow = _libraries['FIXME_STUB'].poly_findroots_bairstow
...
poly_mul = _libraries['FIXME_STUB'].poly_mul
...
polyf_fit_lagrange = _libraries['FIXME_STUB'].polyf_fit_lagrange
...
polyf_interp_lagrange = _libraries['FIXME_STUB'].polyf_interp_lagrange
...
polyf_fit_lagrange_barycentric = _libraries['FIXME_STUB'].polyf_fit_lagrange_barycentric
...
polyf_val_lagrange_barycentric = _libraries['FIXME_STUB'].polyf_val_lagrange_barycentric
...
polyf_expandbinomial = _libraries['FIXME_STUB'].polyf_expandbinomial
polyf_expandbinomial.restype = ctypes.c_int32
polyf_expandbinomial.argtypes = [ctypes.c_uint32, ctypes.POINTER(ctypes.c_float)]
polyf_expandbinomial_pm = _libraries['FIXME_STUB'].polyf_expandbinomial_pm
...
polyf_expandroots = _libraries['FIXME_STUB'].polyf_expandroots
...
polyf_expandroots2 = _libraries['FIXME_STUB'].polyf_expandroots2
...
polyf_findroots = _libraries['FIXME_STUB'].polyf_findroots
...
polyf_findroots_durandkerner = _libraries['FIXME_STUB'].polyf_findroots_durandkerner
...
polyf_findroots_bairstow = _libraries['FIXME_STUB'].polyf_findroots_bairstow
...
polyf_mul = _libraries['FIXME_STUB'].polyf_mul
...
polyc_val = _libraries['FIXME_STUB'].polyc_val
...
polyc_fit = _libraries['FIXME_STUB'].polyc_fit
...
polyc_fit_lagrange = _libraries['FIXME_STUB'].polyc_fit_lagrange
...
polyc_interp_lagrange = _libraries['FIXME_STUB'].polyc_interp_lagrange
...
polyc_fit_lagrange_barycentric = _libraries['FIXME_STUB'].polyc_fit_lagrange_barycentric
...
polyc_val_lagrange_barycentric = _libraries['FIXME_STUB'].polyc_val_lagrange_barycentric
...
polyc_expandbinomial = _libraries['FIXME_STUB'].polyc_expandbinomial
...
polyc_expandbinomial_pm = _libraries['FIXME_STUB'].polyc_expandbinomial_pm
...
polyc_expandroots = _libraries['FIXME_STUB'].polyc_expandroots
...
polyc_expandroots2 = _libraries['FIXME_STUB'].polyc_expandroots2
...
polyc_findroots = _libraries['FIXME_STUB'].polyc_findroots
...
polyc_findroots_durandkerner = _libraries['FIXME_STUB'].polyc_findroots_durandkerner
...
polyc_findroots_bairstow = _libraries['FIXME_STUB'].polyc_findroots_bairstow
...
polyc_mul = _libraries['FIXME_STUB'].polyc_mul
...
polycf_val = _libraries['FIXME_STUB'].polycf_val
...
polycf_fit = _libraries['FIXME_STUB'].polycf_fit
...
polycf_fit_lagrange = _libraries['FIXME_STUB'].polycf_fit_lagrange
...
polycf_interp_lagrange = _libraries['FIXME_STUB'].polycf_interp_lagrange
...
polycf_fit_lagrange_barycentric = _libraries['FIXME_STUB'].polycf_fit_lagrange_barycentric
...
polycf_val_lagrange_barycentric = _libraries['FIXME_STUB'].polycf_val_lagrange_barycentric
...
polycf_expandbinomial = _libraries['FIXME_STUB'].polycf_expandbinomial
...
polycf_expandbinomial_pm = _libraries['FIXME_STUB'].polycf_expandbinomial_pm
...
polycf_expandroots = _libraries['FIXME_STUB'].polycf_expandroots
...
polycf_expandroots2 = _libraries['FIXME_STUB'].polycf_expandroots2
...
polycf_findroots = _libraries['FIXME_STUB'].polycf_findroots
...
polycf_findroots_durandkerner = _libraries['FIXME_STUB'].polycf_findroots_durandkerner
...
polycf_findroots_bairstow = _libraries['FIXME_STUB'].polycf_findroots_bairstow
...
polycf_mul = _libraries['FIXME_STUB'].polycf_mul
...
liquid_is_prime = _libraries['FIXME_STUB'].liquid_is_prime
liquid_is_prime.restype = ctypes.c_int32
liquid_is_prime.argtypes = [ctypes.c_uint32]
liquid_factor = _libraries['FIXME_STUB'].liquid_factor
...
liquid_unique_factor = _libraries['FIXME_STUB'].liquid_unique_factor
...
matrixf_sub = _libraries['FIXME_STUB'].matrixf_sub
...
matrixf_pmul = _libraries['FIXME_STUB'].matrixf_pmul
...
matrixf_pdiv = _libraries['FIXME_STUB'].matrixf_pdiv
...
matrixf_mul = _libraries['FIXME_STUB'].matrixf_mul
...
matrixf_div = _libraries['FIXME_STUB'].matrixf_div
...
matrixf_mul_transpose = _libraries['FIXME_STUB'].matrixf_mul_transpose
...
matrixf_transpose_mul = _libraries['FIXME_STUB'].matrixf_transpose_mul
...
matrixf_mul_hermitian = _libraries['FIXME_STUB'].matrixf_mul_hermitian
...
matrixf_hermitian_mul = _libraries['FIXME_STUB'].matrixf_hermitian_mul
...
matrixf_aug = _libraries['FIXME_STUB'].matrixf_aug
...
matrixf_pivot = _libraries['FIXME_STUB'].matrixf_pivot
...
matrixf_swaprows = _libraries['FIXME_STUB'].matrixf_swaprows
...
matrixf_linsolve = _libraries['FIXME_STUB'].matrixf_linsolve
...
matrixf_cgsolve = _libraries['FIXME_STUB'].matrixf_cgsolve
...
matrixf_ludecomp_crout = _libraries['FIXME_STUB'].matrixf_ludecomp_crout
...
matrixf_ludecomp_doolittle = _libraries['FIXME_STUB'].matrixf_ludecomp_doolittle
...
matrixf_gramschmidt = _libraries['FIXME_STUB'].matrixf_gramschmidt
...
matrixf_qrdecomp_gramschmidt = _libraries['FIXME_STUB'].matrixf_qrdecomp_gramschmidt
...
matrixf_chol = _libraries['FIXME_STUB'].matrixf_chol
...
matrix_sub = _libraries['FIXME_STUB'].matrix_sub
...
matrix_pmul = _libraries['FIXME_STUB'].matrix_pmul
...
matrix_pdiv = _libraries['FIXME_STUB'].matrix_pdiv
...
matrix_mul = _libraries['FIXME_STUB'].matrix_mul
...
matrix_div = _libraries['FIXME_STUB'].matrix_div
...
matrix_mul_transpose = _libraries['FIXME_STUB'].matrix_mul_transpose
...
matrix_transpose_mul = _libraries['FIXME_STUB'].matrix_transpose_mul
...
matrix_mul_hermitian = _libraries['FIXME_STUB'].matrix_mul_hermitian
...
matrix_hermitian_mul = _libraries['FIXME_STUB'].matrix_hermitian_mul
...
matrix_aug = _libraries['FIXME_STUB'].matrix_aug
...
matrix_pivot = _libraries['FIXME_STUB'].matrix_pivot
...
matrix_swaprows = _libraries['FIXME_STUB'].matrix_swaprows
...
matrix_linsolve = _libraries['FIXME_STUB'].matrix_linsolve
...
matrix_cgsolve = _libraries['FIXME_STUB'].matrix_cgsolve
...
matrix_ludecomp_crout = _libraries['FIXME_STUB'].matrix_ludecomp_crout
...
matrix_ludecomp_doolittle = _libraries['FIXME_STUB'].matrix_ludecomp_doolittle
...
matrix_gramschmidt = _libraries['FIXME_STUB'].matrix_gramschmidt
...
matrix_qrdecomp_gramschmidt = _libraries['FIXME_STUB'].matrix_qrdecomp_gramschmidt
...
matrix_chol = _libraries['FIXME_STUB'].matrix_chol
...
matrixcf_print = _libraries['FIXME_STUB'].matrixcf_print
...
matrixcf_add = _libraries['FIXME_STUB'].matrixcf_add
...
matrixcf_sub = _libraries['FIXME_STUB'].matrixcf_sub
...
matrixcf_pmul = _libraries['FIXME_STUB'].matrixcf_pmul
...
matrixcf_pdiv = _libraries['FIXME_STUB'].matrixcf_pdiv
...
matrixcf_mul = _libraries['FIXME_STUB'].matrixcf_mul
...
matrixcf_div = _libraries['FIXME_STUB'].matrixcf_div
...
matrixcf_det = _libraries['FIXME_STUB'].matrixcf_det
...
matrixcf_trans = _libraries['FIXME_STUB'].matrixcf_trans
...
matrixcf_hermitian = _libraries['FIXME_STUB'].matrixcf_hermitian
...
matrixcf_mul_transpose = _libraries['FIXME_STUB'].matrixcf_mul_transpose
...
matrixcf_transpose_mul = _libraries['FIXME_STUB'].matrixcf_transpose_mul
...
matrixcf_mul_hermitian = _libraries['FIXME_STUB'].matrixcf_mul_hermitian
...
matrixcf_hermitian_mul = _libraries['FIXME_STUB'].matrixcf_hermitian_mul
...
matrixcf_aug = _libraries['FIXME_STUB'].matrixcf_aug
...
matrixcf_inv = _libraries['FIXME_STUB'].matrixcf_inv
...
matrixcf_eye = _libraries['FIXME_STUB'].matrixcf_eye
...
matrixcf_ones = _libraries['FIXME_STUB'].matrixcf_ones
...
matrixcf_zeros = _libraries['FIXME_STUB'].matrixcf_zeros
...
matrixcf_gjelim = _libraries['FIXME_STUB'].matrixcf_gjelim
...
matrixcf_pivot = _libraries['FIXME_STUB'].matrixcf_pivot
...
matrixcf_swaprows = _libraries['FIXME_STUB'].matrixcf_swaprows
...
matrixcf_linsolve = _libraries['FIXME_STUB'].matrixcf_linsolve
...
matrixcf_cgsolve = _libraries['FIXME_STUB'].matrixcf_cgsolve
...
matrixcf_ludecomp_crout = _libraries['FIXME_STUB'].matrixcf_ludecomp_crout
...
matrixcf_ludecomp_doolittle = _libraries['FIXME_STUB'].matrixcf_ludecomp_doolittle
...
matrixcf_gramschmidt = _libraries['FIXME_STUB'].matrixcf_gramschmidt
...
matrixcf_qrdecomp_gramschmidt = _libraries['FIXME_STUB'].matrixcf_qrdecomp_gramschmidt
...
matrixcf_chol = _libraries['FIXME_STUB'].matrixcf_chol
...
matrixc_print = _libraries['FIXME_STUB'].matrixc_print
...
matrixc_add = _libraries['FIXME_STUB'].matrixc_add
...
matrixc_sub = _libraries['FIXME_STUB'].matrixc_sub
...
matrixc_pmul = _libraries['FIXME_STUB'].matrixc_pmul
...
matrixc_pdiv = _libraries['FIXME_STUB'].matrixc_pdiv
...
matrixc_mul = _libraries['FIXME_STUB'].matrixc_mul
...
matrixc_div = _libraries['FIXME_STUB'].matrixc_div
...
matrixc_det = _libraries['FIXME_STUB'].matrixc_det
...
matrixc_trans = _libraries['FIXME_STUB'].matrixc_trans
...
matrixc_hermitian = _libraries['FIXME_STUB'].matrixc_hermitian
...
matrixc_mul_transpose = _libraries['FIXME_STUB'].matrixc_mul_transpose
...
matrixc_transpose_mul = _libraries['FIXME_STUB'].matrixc_transpose_mul
...
matrixc_mul_hermitian = _libraries['FIXME_STUB'].matrixc_mul_hermitian
...
matrixc_hermitian_mul = _libraries['FIXME_STUB'].matrixc_hermitian_mul
...
matrixc_aug = _libraries['FIXME_STUB'].matrixc_aug
...
matrixc_inv = _libraries['FIXME_STUB'].matrixc_inv
...
matrixc_zeros = _libraries['FIXME_STUB'].matrixc_zeros
...
matrixc_gjelim = _libraries['FIXME_STUB'].matrixc_gjelim
...
matrixc_pivot = _libraries['FIXME_STUB'].matrixc_pivot
...
matrixc_swaprows = _libraries['FIXME_STUB'].matrixc_swaprows
...
matrixc_linsolve = _libraries['FIXME_STUB'].matrixc_linsolve
...
matrixc_cgsolve = _libraries['FIXME_STUB'].matrixc_cgsolve
...
matrixc_ludecomp_crout = _libraries['FIXME_STUB'].matrixc_ludecomp_crout
...
matrixc_ludecomp_doolittle = _libraries['FIXME_STUB'].matrixc_ludecomp_doolittle
...
matrixc_gramschmidt = _libraries['FIXME_STUB'].matrixc_gramschmidt
...
matrixc_qrdecomp_gramschmidt = _libraries['FIXME_STUB'].matrixc_qrdecomp_gramschmidt
...
matrixc_chol = _libraries['FIXME_STUB'].matrixc_chol
...
smatrixb_create = _libraries['FIXME_STUB'].smatrixb_create
smatrixb_create.restype = smatrixb
smatrixb_create.argtypes = [ctypes.c_uint32, ctypes.c_uint32]
smatrixb_create_array = _libraries['FIXME_STUB'].smatrixb_create_array
...
smatrixf_create = _libraries['FIXME_STUB'].smatrixf_create
smatrixf_create.restype = smatrixf
smatrixf_create.argtypes = [ctypes.c_uint32, ctypes.c_uint32]
smatrixf_create_array = _libraries['FIXME_STUB'].smatrixf_create_array
...
smatrixi_create = _libraries['FIXME_STUB'].smatrixi_create
smatrixi_create.restype = smatrixi
smatrixi_create.argtypes = [ctypes.c_uint32, ctypes.c_uint32]
smatrixi_create_array = _libraries['FIXME_STUB'].smatrixi_create_array
...
smatrixb_mulf = _libraries['FIXME_STUB'].smatrixb_mulf
...
smatrixb_vmulf = _libraries['FIXME_STUB'].smatrixb_vmulf
...
gray_encode = _libraries['FIXME_STUB'].gray_encode
gray_encode.restype = ctypes.c_uint32
gray_encode.argtypes = [ctypes.c_uint32]
gray_decode = _libraries['FIXME_STUB'].gray_decode
gray_decode.restype = ctypes.c_uint32
gray_decode.argtypes = [ctypes.c_uint32]
liquid_pack_soft_bits = _libraries['FIXME_STUB'].liquid_pack_soft_bits
...
liquid_unpack_soft_bits = _libraries['FIXME_STUB'].liquid_unpack_soft_bits
...
modem_create = _libraries['FIXME_STUB'].modem_create
modem_create.restype = modem
modem_create.argtypes = [modulation_scheme]
modem_create_arbitrary = _libraries['FIXME_STUB'].modem_create_arbitrary
...
modem_demodulate = _libraries['FIXME_STUB'].modem_demodulate
...
modem_demodulate_soft = _libraries['FIXME_STUB'].modem_demodulate_soft
...
modem_get_demodulator_sample = _libraries['FIXME_STUB'].modem_get_demodulator_sample
...
modem_get_demodulator_phase_error = _libraries['FIXME_STUB'].modem_get_demodulator_phase_error
modem_get_demodulator_phase_error.restype = ctypes.c_float
modem_get_demodulator_phase_error.argtypes = [modem]
modem_get_demodulator_evm = _libraries['FIXME_STUB'].modem_get_demodulator_evm
...
cpfskmod_create = _libraries['FIXME_STUB'].cpfskmod_create
...
cpfskdem_create = _libraries['FIXME_STUB'].cpfskdem_create
...
fskdem_get_frequency_error = _libraries['FIXME_STUB'].fskdem_get_frequency_error
fskdem_get_frequency_error.restype = ctypes.c_float
fskdem_get_frequency_error.argtypes = [fskdem]
fskdem_get_symbol_energy = _libraries['FIXME_STUB'].fskdem_get_symbol_energy
...
freqmod_modulate_block = _libraries['FIXME_STUB'].freqmod_modulate_block
...
freqdem_demodulate_block = _libraries['FIXME_STUB'].freqdem_demodulate_block
...
ampmodem_modulate_block = _libraries['FIXME_STUB'].ampmodem_modulate_block
...
ampmodem_demodulate = _libraries['FIXME_STUB'].ampmodem_demodulate
...
ampmodem_demodulate_block = _libraries['FIXME_STUB'].ampmodem_demodulate_block
...
firpfbch_crcf_create = _libraries['FIXME_STUB'].firpfbch_crcf_create
...
firpfbch_crcf_create_kaiser = _libraries['FIXME_STUB'].firpfbch_crcf_create_kaiser
...
firpfbch_crcf_create_rnyquist = _libraries['FIXME_STUB'].firpfbch_crcf_create_rnyquist
...
firpfbch_crcf_destroy = _libraries['FIXME_STUB'].firpfbch_crcf_destroy
firpfbch_crcf_destroy.restype = ctypes.c_int32
firpfbch_crcf_destroy.argtypes = [firpfbch_crcf]
firpfbch_crcf_reset = _libraries['FIXME_STUB'].firpfbch_crcf_reset
firpfbch_crcf_reset.restype = ctypes.c_int32
firpfbch_crcf_reset.argtypes = [firpfbch_crcf]
firpfbch_crcf_print = _libraries['FIXME_STUB'].firpfbch_crcf_print
firpfbch_crcf_print.restype = ctypes.c_int32
firpfbch_crcf_print.argtypes = [firpfbch_crcf]
firpfbch_crcf_synthesizer_execute = _libraries['FIXME_STUB'].firpfbch_crcf_synthesizer_execute
...
firpfbch_crcf_analyzer_execute = _libraries['FIXME_STUB'].firpfbch_crcf_analyzer_execute
...
firpfbch_cccf_create = _libraries['FIXME_STUB'].firpfbch_cccf_create
...
firpfbch_cccf_create_kaiser = _libraries['FIXME_STUB'].firpfbch_cccf_create_kaiser
...
firpfbch_cccf_create_rnyquist = _libraries['FIXME_STUB'].firpfbch_cccf_create_rnyquist
...
firpfbch_cccf_destroy = _libraries['FIXME_STUB'].firpfbch_cccf_destroy
firpfbch_cccf_destroy.restype = ctypes.c_int32
firpfbch_cccf_destroy.argtypes = [firpfbch_cccf]
firpfbch_cccf_reset = _libraries['FIXME_STUB'].firpfbch_cccf_reset
firpfbch_cccf_reset.restype = ctypes.c_int32
firpfbch_cccf_reset.argtypes = [firpfbch_cccf]
firpfbch_cccf_print = _libraries['FIXME_STUB'].firpfbch_cccf_print
firpfbch_cccf_print.restype = ctypes.c_int32
firpfbch_cccf_print.argtypes = [firpfbch_cccf]
firpfbch_cccf_synthesizer_execute = _libraries['FIXME_STUB'].firpfbch_cccf_synthesizer_execute
...
firpfbch_cccf_analyzer_execute = _libraries['FIXME_STUB'].firpfbch_cccf_analyzer_execute
...
firpfbch2_crcf_create = _libraries['FIXME_STUB'].firpfbch2_crcf_create
...
firpfbch2_crcf_create_kaiser = _libraries['FIXME_STUB'].firpfbch2_crcf_create_kaiser
...
firpfbchr_crcf_create = _libraries['FIXME_STUB'].firpfbchr_crcf_create
...
firpfbchr_crcf_create_kaiser = _libraries['FIXME_STUB'].firpfbchr_crcf_create_kaiser
...
firpfbchr_crcf_destroy = _libraries['FIXME_STUB'].firpfbchr_crcf_destroy
...
firpfbchr_crcf_execute = _libraries['FIXME_STUB'].firpfbchr_crcf_execute
...
ofdmframe_init_default_sctype = _libraries['FIXME_STUB'].ofdmframe_init_default_sctype
...
ofdmframe_init_sctype_range = _libraries['FIXME_STUB'].ofdmframe_init_sctype_range
...
ofdmframe_validate_sctype = _libraries['FIXME_STUB'].ofdmframe_validate_sctype
...
ofdmframe_print_sctype = _libraries['FIXME_STUB'].ofdmframe_print_sctype
...
ofdmframegen_create = _libraries['FIXME_STUB'].ofdmframegen_create
...
ofdmframegen_destroy = _libraries['FIXME_STUB'].ofdmframegen_destroy
ofdmframegen_destroy.restype = ctypes.c_int32
ofdmframegen_destroy.argtypes = [ofdmframegen]
ofdmframegen_print = _libraries['FIXME_STUB'].ofdmframegen_print
ofdmframegen_print.restype = ctypes.c_int32
ofdmframegen_print.argtypes = [ofdmframegen]
ofdmframegen_reset = _libraries['FIXME_STUB'].ofdmframegen_reset
ofdmframegen_reset.restype = ctypes.c_int32
ofdmframegen_reset.argtypes = [ofdmframegen]
ofdmframegen_write_S0a = _libraries['FIXME_STUB'].ofdmframegen_write_S0a
...
ofdmframegen_write_S0b = _libraries['FIXME_STUB'].ofdmframegen_write_S0b
...
ofdmframegen_write_S1 = _libraries['FIXME_STUB'].ofdmframegen_write_S1
...
ofdmframegen_writesymbol = _libraries['FIXME_STUB'].ofdmframegen_writesymbol
...
ofdmframegen_writetail = _libraries['FIXME_STUB'].ofdmframegen_writetail
...
ofdmframesync_create = _libraries['FIXME_STUB'].ofdmframesync_create
...
nco_crcf_mix_down = _libraries['FIXME_STUB'].nco_crcf_mix_down
...
nco_crcf_mix_block_up = _libraries['FIXME_STUB'].nco_crcf_mix_block_up
...
nco_crcf_mix_block_down = _libraries['FIXME_STUB'].nco_crcf_mix_block_down
...
liquid_unwrap_phase = _libraries['FIXME_STUB'].liquid_unwrap_phase
liquid_unwrap_phase.restype = None
liquid_unwrap_phase.argtypes = [ctypes.POINTER(ctypes.c_float), ctypes.c_uint32]
liquid_unwrap_phase2 = _libraries['FIXME_STUB'].liquid_unwrap_phase2
...
synth_crcf_create = _libraries['FIXME_STUB'].synth_crcf_create
...
synth_crcf_mix_down = _libraries['FIXME_STUB'].synth_crcf_mix_down
...
synth_crcf_mix_block_up = _libraries['FIXME_STUB'].synth_crcf_mix_block_up
...
synth_crcf_mix_block_down = _libraries['FIXME_STUB'].synth_crcf_mix_block_down
...
synth_crcf_spread = _libraries['FIXME_STUB'].synth_crcf_spread
...
synth_crcf_despread = _libraries['FIXME_STUB'].synth_crcf_despread
...
synth_crcf_despread_triple = _libraries['FIXME_STUB'].synth_crcf_despread_triple
...
liquid_rosenbrock = _libraries['FIXME_STUB'].liquid_rosenbrock
...
liquid_invgauss = _libraries['FIXME_STUB'].liquid_invgauss
...
liquid_multimodal = _libraries['FIXME_STUB'].liquid_multimodal
...
liquid_spiral = _libraries['FIXME_STUB'].liquid_spiral
...
gradsearch_create = _libraries['FIXME_STUB'].gradsearch_create
...
gradsearch_destroy = _libraries['FIXME_STUB'].gradsearch_destroy
gradsearch_destroy.restype = None
gradsearch_destroy.argtypes = [gradsearch]
gradsearch_print = _libraries['FIXME_STUB'].gradsearch_print
gradsearch_print.restype = None
gradsearch_print.argtypes = [gradsearch]
gradsearch_step = _libraries['FIXME_STUB'].gradsearch_step
gradsearch_step.restype = ctypes.c_float
gradsearch_step.argtypes = [gradsearch]
gradsearch_execute = _libraries['FIXME_STUB'].gradsearch_execute
...
qnsearch_create = _libraries['FIXME_STUB'].qnsearch_create
...
chromosome_init_random = _libraries['FIXME_STUB'].chromosome_init_random
chromosome_init_random.restype = ctypes.c_int32
chromosome_init_random.argtypes = [chromosome]
chromosome_value = _libraries['FIXME_STUB'].chromosome_value
chromosome_value.restype = ctypes.c_uint32
chromosome_value.argtypes = [chromosome, ctypes.c_uint32]
chromosome_valuef = _libraries['FIXME_STUB'].chromosome_valuef
...
gasearch_create = _libraries['FIXME_STUB'].gasearch_create
gasearch_create.restype = gasearch
gasearch_create.argtypes = [gasearch_utility, ctypes.POINTER(None), chromosome, ctypes.c_int32]
gasearch_create_advanced = _libraries['FIXME_STUB'].gasearch_create_advanced
...
gasearch_destroy = _libraries['FIXME_STUB'].gasearch_destroy
gasearch_destroy.restype = ctypes.c_int32
gasearch_destroy.argtypes = [gasearch]
gasearch_print = _libraries['FIXME_STUB'].gasearch_print
gasearch_print.restype = ctypes.c_int32
gasearch_print.argtypes = [gasearch]
gasearch_set_mutation_rate = _libraries['FIXME_STUB'].gasearch_set_mutation_rate
gasearch_set_mutation_rate.restype = ctypes.c_int32
gasearch_set_mutation_rate.argtypes = [gasearch, ctypes.c_float]
gasearch_set_population_size = _libraries['FIXME_STUB'].gasearch_set_population_size
...
expand_cf_mulaw = _libraries['FIXME_STUB'].expand_cf_mulaw
...
quantize_adc = _libraries['FIXME_STUB'].quantize_adc
quantize_adc.restype = ctypes.c_uint32
quantize_adc.argtypes = [ctypes.c_float, ctypes.c_uint32]
quantize_dac = _libraries['FIXME_STUB'].quantize_dac
...
quantizerf_execute_dac = _libraries['FIXME_STUB'].quantizerf_execute_dac
...
quantizercf_execute_dac = _libraries['FIXME_STUB'].quantizercf_execute_dac
...
liquid_unpack_array = _libraries['FIXME_STUB'].liquid_unpack_array
...
liquid_pack_bytes = _libraries['FIXME_STUB'].liquid_pack_bytes
...
liquid_unpack_bytes = _libraries['FIXME_STUB'].liquid_unpack_bytes
...
liquid_repack_bytes = _libraries['FIXME_STUB'].liquid_repack_bytes
...
liquid_lbshift = _libraries['FIXME_STUB'].liquid_lbshift
...
liquid_rbshift = _libraries['FIXME_STUB'].liquid_rbshift
...
liquid_lbcircshift = _libraries['FIXME_STUB'].liquid_lbcircshift
...
liquid_rbcircshift = _libraries['FIXME_STUB'].liquid_rbcircshift
...
liquid_rcircshift = _libraries['FIXME_STUB'].liquid_rcircshift
...
liquid_vectorf_init = _libraries['FIXME_STUB'].liquid_vectorf_init
...
liquid_vectorf_add = _libraries['FIXME_STUB'].liquid_vectorf_add
...
liquid_vectorf_addscalar = _libraries['FIXME_STUB'].liquid_vectorf_addscalar
...
liquid_vectorf_mul = _libraries['FIXME_STUB'].liquid_vectorf_mul
...
liquid_vectorf_mulscalar = _libraries['FIXME_STUB'].liquid_vectorf_mulscalar
...
liquid_vectorf_cexpj = _libraries['FIXME_STUB'].liquid_vectorf_cexpj
...
liquid_vectorf_carg = _libraries['FIXME_STUB'].liquid_vectorf_carg
...
liquid_vectorf_abs = _libraries['FIXME_STUB'].liquid_vectorf_abs
...
liquid_vectorf_normalize = _libraries['FIXME_STUB'].liquid_vectorf_normalize
...
liquid_vectorcf_init = _libraries['FIXME_STUB'].liquid_vectorcf_init
...
liquid_vectorcf_add = _libraries['FIXME_STUB'].liquid_vectorcf_add
...
liquid_vectorcf_addscalar = _libraries['FIXME_STUB'].liquid_vectorcf_addscalar
...
liquid_vectorcf_mul = _libraries['FIXME_STUB'].liquid_vectorcf_mul
...
liquid_vectorcf_mulscalar = _libraries['FIXME_STUB'].liquid_vectorcf_mulscalar
...
liquid_vectorcf_cexpj = _libraries['FIXME_STUB'].liquid_vectorcf_cexpj
...
liquid_vectorcf_carg = _libraries['FIXME_STUB'].liquid_vectorcf_carg
...
liquid_vectorcf_abs = _libraries['FIXME_STUB'].liquid_vectorcf_abs
...
liquid_vectorcf_sumsq = _libraries['FIXME_STUB'].liquid_vectorcf_sumsq
...
liquid_vectorcf_norm = _libraries['FIXME_STUB'].liquid_vectorcf_norm
...
liquid_vectorcf_pnorm = _libraries['FIXME_STUB'].liquid_vectorcf_pnorm
...
liquid_vectorcf_normalize = _libraries['FIXME_STUB'].liquid_vectorcf_normalize
...
__all__ = \
    ...
    'liquid_vectorcf_pnorm', 'liquid_vectorcf_sumsq',
    ...
    'liquid_vectorf_pnorm', 'liquid_vectorf_sumsq', 'liquid_version',
    ...
    'poly_findroots_durandkerner', 'poly_fit', 'poly_fit_lagrange',
    ...
    'qdetector_cccf_set_threshold', 'qnsearch', 'qnsearch_create',
    'qnsearch_destroy', 'qnsearch_execute', 'qnsearch_print',
    'qnsearch_reset', 'qnsearch_step', 'qpacketmodem',
    ...
    'struct_qnsearch_s', 'struct_qpacketmodem_s',
